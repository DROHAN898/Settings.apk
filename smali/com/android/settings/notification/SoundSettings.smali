...
# direct methods
.method static synthetic -get0(Lcom/android/settings/notification/SoundSettings;)Landroid/content/Context;
    .locals 1
...
.method static synthetic -get1(Lcom/android/settings/notification/SoundSettings;)Lcom/android/settings/notification/SoundSettings$H;
    .locals 1
...
.method static synthetic -get2(Lcom/android/settings/notification/SoundSettings;)Lcom/android/settings/notification/IncreasingRingVolumePreference;
    .locals 1
...
.method static synthetic -get4(Lcom/android/settings/notification/SoundSettings;)Ljava/util/ArrayList;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/notification/SoundSettings;->mPhoneRingtonePreferences:Ljava/util/ArrayList;
...
.method static synthetic -wrap1(Landroid/content/Context;II)Ljava/lang/CharSequence;
    ...
    .prologue
    invoke-static {p0, p1, p2}, Lcom/android/settings/notification/SoundSettings;->updateRingtoneName(Landroid/content/Context;II)Ljava/lang/CharSequence;
...
.method static synthetic -wrap3(Lcom/android/settings/notification/SoundSettings;)V
    ...
    invoke-direct {p0}, Lcom/android/settings/notification/SoundSettings;->updateNotificationPreferenceState()V
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/notification/SoundSettings;->TAG:Ljava/lang/String;
...
.method private getSuppressorCaption(Landroid/content/ComponentName;)Ljava/lang/String;
    ...
    sget-object v5, Lcom/android/settings/notification/SoundSettings;->TAG:Ljava/lang/String;
...
.method private initIncreasingRing(Landroid/preference/PreferenceCategory;)V
    ...
    iput-object v0, p0, Lcom/android/settings/notification/SoundSettings;->mIncreasingRing:Landroid/preference/TwoStatePreference;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/SoundSettings;->mIncreasingRingVolume:Lcom/android/settings/notification/IncreasingRingVolumePreference;
    ...
    .line 467
    iget-object v0, p0, Lcom/android/settings/notification/SoundSettings;->mIncreasingRing:Landroid/preference/TwoStatePreference;
    ...
    .line 469
    iput-object v1, p0, Lcom/android/settings/notification/SoundSettings;->mIncreasingRing:Landroid/preference/TwoStatePreference;
    ...
    iget-object v1, p0, Lcom/android/settings/notification/SoundSettings;->mIncreasingRingVolumeCallback:Lcom/android/settings/notification/IncreasingRingVolumePreference$Callback;
...
.method private initRingtones(Landroid/preference/PreferenceCategory;)V
    ...
    iget-object v6, p0, Lcom/android/settings/notification/SoundSettings;->mPhoneRingtonePreferences:Ljava/util/ArrayList;

    if-eqz v6, :cond_0

    iget-boolean v6, p0, Lcom/android/settings/notification/SoundSettings;->mVoiceCapable:Z

    if-eqz v6, :cond_1

    :cond_0
    invoke-static {}, Lcom/android/settings/Utils;->isUserOwner()Z
    ...
    iput-object v6, p0, Lcom/android/settings/notification/SoundSettings;->mPhoneRingtonePreferences:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings/notification/SoundSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-direct {v2, v6, v8}, Lcom/android/settings/DefaultRingtonePreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, v7, v6}, Lcom/android/settings/notification/SoundSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 360
    iput-object v8, p0, Lcom/android/settings/notification/SoundSettings;->mPhoneRingtonePreferences:Ljava/util/ArrayList;
    ...
    iput-object v6, p0, Lcom/android/settings/notification/SoundSettings;->mNotificationRingtonePreference:Landroid/preference/Preference;
...
.method private initVibrateWhenRinging(Landroid/preference/PreferenceCategory;)V
    ...
    .line 487
    sget-object v0, Lcom/android/settings/notification/SoundSettings;->TAG:Ljava/lang/String;
    ...
    .line 492
    iput-object v1, p0, Lcom/android/settings/notification/SoundSettings;->mVibrateWhenRinging:Landroid/preference/TwoStatePreference;
...
.method private refreshNotificationListeners()V
    ...
    .line 531
    iget-object v1, p0, Lcom/android/settings/notification/SoundSettings;->mNotificationAccess:Landroid/preference/Preference;
...
.method private updateEffectsSuppressor()V
    ...
    .line 294
    iget-object v2, p0, Lcom/android/settings/notification/SoundSettings;->mRingPreference:Lcom/android/settings/notification/VolumeSeekBarPreference;
    ...
    .line 300
    :cond_1
    invoke-direct {p0}, Lcom/android/settings/notification/SoundSettings;->updateRingPreference()V
...
.method private updateNotificationPreferenceState()V
    ...
    .line 253
    iget-object v1, p0, Lcom/android/settings/notification/SoundSettings;->mNotificationPreference:Lcom/android/settings/notification/VolumeSeekBarPreference;
    ...
    iput-object v1, p0, Lcom/android/settings/notification/SoundSettings;->mNotificationPreference:Lcom/android/settings/notification/VolumeSeekBarPreference;
    ...
    .local v0, "enabled":Z
    :goto_0
    iget-object v1, p0, Lcom/android/settings/notification/SoundSettings;->mVolumeLinkNotificationSwitch:Landroid/preference/SwitchPreference;
...
.method private updateRingPreference()V
    ...
    .prologue
    .line 269
    iget-object v0, p0, Lcom/android/settings/notification/SoundSettings;->mRingPreference:Lcom/android/settings/notification/VolumeSeekBarPreference;

    if-eqz v0, :cond_0

    .line 270
    iget-object v1, p0, Lcom/android/settings/notification/SoundSettings;->mRingPreference:Lcom/android/settings/notification/VolumeSeekBarPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v4, p0, Lcom/android/settings/notification/SoundSettings;->mContext:Landroid/content/Context;
    ...
    iput-object v4, p0, Lcom/android/settings/notification/SoundSettings;->mPM:Landroid/content/pm/PackageManager;
    ...
    iput-object v4, p0, Lcom/android/settings/notification/SoundSettings;->mUserManager:Landroid/os/UserManager;
    ...
    iput-boolean v4, p0, Lcom/android/settings/notification/SoundSettings;->mVoiceCapable:Z
    ...
    iput-object v4, p0, Lcom/android/settings/notification/SoundSettings;->mAudioManager:Landroid/media/AudioManager;
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/notification/SoundSettings;->addPreferencesFromResource(I)V

    .line 166
    const-string/jumbo v4, "volumes"

    invoke-virtual {p0, v4}, Lcom/android/settings/notification/SoundSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    .line 174
    iput-object v4, p0, Lcom/android/settings/notification/SoundSettings;->mRingPreference:Lcom/android/settings/notification/VolumeSeekBarPreference;
    ...
    iput-object v4, p0, Lcom/android/settings/notification/SoundSettings;->mVolumeLinkNotificationSwitch:Landroid/preference/SwitchPreference;
    ...
    .line 189
    :cond_1
    invoke-direct {p0, v1}, Lcom/android/settings/notification/SoundSettings;->initRingtones(Landroid/preference/PreferenceCategory;)V

    .line 190
    invoke-direct {p0, v1}, Lcom/android/settings/notification/SoundSettings;->initIncreasingRing(Landroid/preference/PreferenceCategory;)V

    .line 191
    invoke-direct {p0, v2}, Lcom/android/settings/notification/SoundSettings;->initVibrateWhenRinging(Landroid/preference/PreferenceCategory;)V
    ...
    iput-object v4, p0, Lcom/android/settings/notification/SoundSettings;->mNotificationAccess:Landroid/preference/Preference;

    .line 194
    invoke-direct {p0}, Lcom/android/settings/notification/SoundSettings;->refreshNotificationListeners()V
...
.method public onResume()V
    ...
    invoke-virtual {v5, v7}, Lcom/android/settings/notification/SoundSettings$SettingsObserver;->register(Z)V

    .line 206
    iget-object v5, p0, Lcom/android/settings/notification/SoundSettings;->mReceiver:Lcom/android/settings/notification/SoundSettings$Receiver;

    invoke-virtual {v5, v7}, Lcom/android/settings/notification/SoundSettings$Receiver;->register(Z)V
    ...
    .line 209
    iget-object v5, p0, Lcom/android/settings/notification/SoundSettings;->mVolumePrefs:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v5, p0, Lcom/android/settings/notification/SoundSettings;->mIncreasingRingVolume:Lcom/android/settings/notification/IncreasingRingVolumePreference;
    ...
    invoke-virtual {v5}, Lcom/android/settings/notification/IncreasingRingVolumePreference;->onActivityResume()V

    .line 215
    :cond_1
    iget-object v5, p0, Lcom/android/settings/notification/SoundSettings;->mUserManager:Landroid/os/UserManager;
    ...
    sget-object v9, Lcom/android/settings/notification/SoundSettings;->RESTRICTED_KEYS:[Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/notification/SoundSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
