...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/notification/ZenModePrioritySettings;->addPreferencesFromResource(I)V
    ...
    iput-object v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->mReminders:Landroid/preference/SwitchPreference;

    .line 58
    iget-object v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->mReminders:Landroid/preference/SwitchPreference;

    new-instance v3, Lcom/android/settings/notification/ZenModePrioritySettings$1;

    invoke-direct {v3, p0}, Lcom/android/settings/notification/ZenModePrioritySettings$1;-><init>(Lcom/android/settings/notification/ZenModePrioritySettings;)V
    ...
    iput-object v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->mEvents:Landroid/preference/SwitchPreference;

    .line 73
    iget-object v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->mEvents:Landroid/preference/SwitchPreference;

    new-instance v3, Lcom/android/settings/notification/ZenModePrioritySettings$2;

    invoke-direct {v3, p0}, Lcom/android/settings/notification/ZenModePrioritySettings$2;-><init>(Lcom/android/settings/notification/ZenModePrioritySettings;)V
    ...
    iput-object v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->mMessages:Lcom/android/settings/DropDownPreference;

    .line 88
    iget-object v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->mMessages:Lcom/android/settings/DropDownPreference;

    invoke-static {v2}, Lcom/android/settings/notification/ZenModePrioritySettings;->addSources(Lcom/android/settings/DropDownPreference;)V

    .line 89
    iget-object v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->mMessages:Lcom/android/settings/DropDownPreference;

    new-instance v3, Lcom/android/settings/notification/ZenModePrioritySettings$3;

    invoke-direct {v3, p0}, Lcom/android/settings/notification/ZenModePrioritySettings$3;-><init>(Lcom/android/settings/notification/ZenModePrioritySettings;)V
    ...
    iput-object v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->mCalls:Lcom/android/settings/DropDownPreference;

    .line 111
    iget-object v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->mCalls:Lcom/android/settings/DropDownPreference;
    ...
    new-instance v3, Lcom/android/settings/notification/ZenModePrioritySettings$4;

    invoke-direct {v3, p0}, Lcom/android/settings/notification/ZenModePrioritySettings$4;-><init>(Lcom/android/settings/notification/ZenModePrioritySettings;)V
    ...
    iput-object v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->mRepeatCallers:Landroid/preference/SwitchPreference;

    .line 134
    iget-object v2, p0, Lcom/android/settings/notification/ZenModePrioritySettings;->mRepeatCallers:Landroid/preference/SwitchPreference;
    ...
    new-instance v3, Lcom/android/settings/notification/ZenModePrioritySettings$5;

    invoke-direct {v3, p0}, Lcom/android/settings/notification/ZenModePrioritySettings$5;-><init>(Lcom/android/settings/notification/ZenModePrioritySettings;)V
    ...
    .line 152
    .local v1, "vibration":Lcom/android/settings/DropDownPreference;
    const v2, 0x7f0c036c

    invoke-virtual {v1, v2, v7}, Lcom/android/settings/DropDownPreference;->addItem(ILjava/lang/Object;)V
    ...
    .line 157
    new-instance v2, Lcom/android/settings/notification/ZenModePrioritySettings$6;

    invoke-direct {v2, p0}, Lcom/android/settings/notification/ZenModePrioritySettings$6;-><init>(Lcom/android/settings/notification/ZenModePrioritySettings;)V
    ...
    .line 167
    invoke-virtual {p0}, Lcom/android/settings/notification/ZenModePrioritySettings;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/notification/ZenModePrioritySettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
