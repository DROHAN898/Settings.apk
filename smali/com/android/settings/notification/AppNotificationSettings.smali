...
.method static synthetic -wrap1(Lcom/android/settings/notification/AppNotificationSettings;J)V
    .locals 1
    .param p1, "value"    # J

    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/settings/notification/AppNotificationSettings;->updateSoundTimeoutSummary(J)V
...
.method private updateDependents(Z)V
    ...
    :goto_0
    iget-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mBlock:Landroid/preference/SwitchPreference;

    iget-boolean v4, p0, Lcom/android/settings/notification/AppNotificationSettings;->mIsSystemPackage:Z
    ...
    :goto_1
    invoke-direct {p0, v7, v4}, Lcom/android/settings/notification/AppNotificationSettings;->setVisible(Landroid/preference/Preference;Z)V

    .line 309
    iget-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mPriority:Landroid/preference/SwitchPreference;
    ...
    .line 310
    iget-object v4, p0, Lcom/android/settings/notification/AppNotificationSettings;->mPeekable:Landroid/preference/SwitchPreference;

    iget-boolean v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mIsSystemPackage:Z
    ...
    :goto_3
    invoke-direct {p0, v4, v1}, Lcom/android/settings/notification/AppNotificationSettings;->setVisible(Landroid/preference/Preference;Z)V

    .line 311
    iget-object v4, p0, Lcom/android/settings/notification/AppNotificationSettings;->mSensitive:Landroid/preference/SwitchPreference;
    ...
    :goto_4
    invoke-direct {p0, v4, v0}, Lcom/android/settings/notification/AppNotificationSettings;->setVisible(Landroid/preference/Preference;Z)V

    .line 313
    iget-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowOnKeyguard:Landroid/preference/SwitchPreference;
    ...
    .line 314
    iget-object v4, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowNoOngoingOnKeyguard:Landroid/preference/SwitchPreference;
    ...
    :cond_0
    invoke-direct {p0, v4, v6}, Lcom/android/settings/notification/AppNotificationSettings;->setVisible(Landroid/preference/Preference;Z)V
...
.method private updateSoundTimeoutSummary(J)V
    ...
    .line 283
    iget-object v6, p0, Lcom/android/settings/notification/AppNotificationSettings;->mSoundTimeout:Landroid/preference/ListPreference;
    ...
    invoke-virtual {p0, v7, v6}, Lcom/android/settings/notification/AppNotificationSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mContext:Landroid/content/Context;
    ...
    sget-boolean v7, Lcom/android/settings/notification/AppNotificationSettings;->DEBUG:Z
    ...
    .line 121
    :goto_1
    iput v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mUid:I

    .line 124
    iget v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mUid:I
    ...
    invoke-static {v5, v4, v7}, Lcom/android/settings/notification/AppNotificationSettings;->findPackageInfo(Landroid/content/pm/PackageManager;Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    .line 140
    :cond_7
    invoke-static {v5, v1}, Lcom/android/settings/Utils;->isSystemPackage(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mIsSystemPackage:Z

    .line 142
    const v7, 0x7f08000b

    invoke-virtual {p0, v7}, Lcom/android/settings/notification/AppNotificationSettings;->addPreferencesFromResource(I)V

    .line 143
    const-string/jumbo v7, "block"

    invoke-virtual {p0, v7}, Lcom/android/settings/notification/AppNotificationSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v7

    check-cast v7, Landroid/preference/SwitchPreference;

    iput-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mBlock:Landroid/preference/SwitchPreference;
    ...
    iput-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mPriority:Landroid/preference/SwitchPreference;
    ...
    iput-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mPeekable:Landroid/preference/SwitchPreference;
    ...
    iput-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mSensitive:Landroid/preference/SwitchPreference;
    ...
    iput-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowOnKeyguard:Landroid/preference/SwitchPreference;
    ...
    iput-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowNoOngoingOnKeyguard:Landroid/preference/SwitchPreference;
    ...
    iput-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mSoundTimeout:Landroid/preference/ListPreference;

    .line 151
    iget-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mBackend:Lcom/android/settings/notification/NotificationBackend;

    iget-object v10, v1, Landroid/content/pm/PackageInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    invoke-virtual {v7, v5, v10}, Lcom/android/settings/notification/NotificationBackend;->loadAppRow(Landroid/content/pm/PackageManager;Landroid/content/pm/ApplicationInfo;)Lcom/android/settings/notification/NotificationBackend$AppRow;

    move-result-object v7

    iput-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings/notification/NotificationBackend$AppRow;
    ...
    .line 155
    .local v6, "rows":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/settings/notification/NotificationBackend$AppRow;>;"
    ...
    invoke-static {v7, v6}, Lcom/android/settings/notification/AppNotificationSettings;->collectConfigActivities(Landroid/content/pm/PackageManager;Landroid/util/ArrayMap;)V
    ...
    iget-boolean v10, v10, Lcom/android/settings/notification/NotificationBackend$AppRow;->banned:Z
    ...
    invoke-direct {p0, v7}, Lcom/android/settings/notification/AppNotificationSettings;->updateDependents(Z)V
    ...
    .line 161
    iget-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mPeekable:Landroid/preference/SwitchPreference;
    ...
    .line 162
    iget-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mSensitive:Landroid/preference/SwitchPreference;
    ...
    .line 163
    iget-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mSoundTimeout:Landroid/preference/ListPreference;

    iget-object v10, p0, Lcom/android/settings/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings/notification/NotificationBackend$AppRow;

    iget-wide v10, v10, Lcom/android/settings/notification/NotificationBackend$AppRow;->soundTimeout:J
    ...
    iget-wide v10, v7, Lcom/android/settings/notification/NotificationBackend$AppRow;->soundTimeout:J

    invoke-direct {p0, v10, v11}, Lcom/android/settings/notification/AppNotificationSettings;->updateSoundTimeoutSummary(J)V
    ...
    invoke-direct {v10, p0, v4}, Lcom/android/settings/notification/AppNotificationSettings$1;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;)V
    ...
    invoke-direct {v10, p0, v4}, Lcom/android/settings/notification/AppNotificationSettings$2;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;)V
    ...
    invoke-direct {v10, p0, v4}, Lcom/android/settings/notification/AppNotificationSettings$3;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;)V
    ...
    invoke-direct {v10, p0, v4}, Lcom/android/settings/notification/AppNotificationSettings$4;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;)V
    ...
    invoke-direct {v10, p0, v4}, Lcom/android/settings/notification/AppNotificationSettings$5;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;)V
    ...
    iget-object v7, v7, Lcom/android/settings/notification/NotificationBackend$AppRow;->settingsIntent:Landroid/content/Intent;
    ...
    invoke-virtual {v7, v4, v10}, Lcom/android/settings/notification/NotificationBackend;->getShowNotificationForPackageOnKeyguard(Ljava/lang/String;I)I

    move-result v3

    .line 231
    .local v3, "keyguard":I
    iget-object v10, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowOnKeyguard:Landroid/preference/SwitchPreference;
    ...
    .line 232
    iget-object v7, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowNoOngoingOnKeyguard:Landroid/preference/SwitchPreference;
    ...
    new-instance v8, Lcom/android/settings/notification/AppNotificationSettings$7;

    invoke-direct {v8, p0, v4}, Lcom/android/settings/notification/AppNotificationSettings$7;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;)V
    ...
    new-instance v8, Lcom/android/settings/notification/AppNotificationSettings$8;

    invoke-direct {v8, p0, v4}, Lcom/android/settings/notification/AppNotificationSettings$8;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings/notification/AppNotificationSettings;->removePreference(Ljava/lang/String;)V
    ...
    iget-object v8, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowNoOngoingOnKeyguard:Landroid/preference/SwitchPreference;
    ...
    iget-object v8, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowOnKeyguard:Landroid/preference/SwitchPreference;
