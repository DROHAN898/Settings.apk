...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/settings/SecuritySettings;->mFilterType:I
...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    sget v39, Lcom/android/settings/SecuritySettings;->MY_USER_ID:I
    ...
    iput-object v0, v1, Lcom/android/settings/SecuritySettings;->mLockscreenDisabledPreference:Landroid/preference/Preference;

    .line 271
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/SecuritySettings;->mLockscreenDisabledPreference:Landroid/preference/Preference;
    ...
    iget v0, v0, Lcom/android/settings/SecuritySettings;->mFilterType:I
    ...
    invoke-static/range {v39 .. v40}, Lcom/android/settings/SecuritySettings;->getResIdForLockUnlockScreen(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;)I
    ...
    new-instance v40, Lcom/android/settings/SecuritySettings$1;
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/SecuritySettings;->maybeAddFingerprintPreference(Landroid/preference/PreferenceGroup;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/SecuritySettings;->addTrustAgentSettings(Landroid/preference/PreferenceGroup;)V
    ...
    iput-object v0, v1, Lcom/android/settings/SecuritySettings;->mDirectlyShow:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/SecuritySettings;->mVisibleErrorPattern:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/SecuritySettings;->mVisibleDots:Landroid/preference/SwitchPreference;
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/SecuritySettings;->setLiveLockScreenPreferenceTitleAndSummary(Landroid/preference/Preference;)V
    ...
    sget v40, Lcom/android/settings/SecuritySettings;->MY_USER_ID:I
    ...
    invoke-static/range {v39 .. v39}, Lcom/android/settings/search/Index;->getInstance(Landroid/content/Context;)Lcom/android/settings/search/Index;

    move-result-object v39

    .line 512
    const-class v40, Lcom/android/settings/SecuritySettings;
    ...
    .line 511
    invoke-virtual/range {v39 .. v42}, Lcom/android/settings/search/Index;->updateFromClassNameResource(Ljava/lang/String;ZZ)V
    ...
    .local v14, "i":I
    :goto_a
    sget-object v39, Lcom/android/settings/SecuritySettings;->SWITCH_PREFERENCE_KEYS:[Ljava/lang/String;
    ...
    const-class v40, Lcom/android/settings/IccLockSettings;
...
.method private setLiveLockScreenPreferenceTitleAndSummary(Landroid/preference/Preference;)V
    ...
    invoke-virtual {p0, v11}, Lcom/android/settings/SecuritySettings;->getString(I)Ljava/lang/String;
...
.method private updateSmsSecuritySummary(I)V
    ...
    invoke-virtual {p0, v2, v1}, Lcom/android/settings/SecuritySettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 189
    const-class v5, Lcom/android/settings/Settings$LockScreenSettingsActivity;
    ...
    iput v4, p0, Lcom/android/settings/SecuritySettings;->mFilterType:I
    ...
    iput-object v4, p0, Lcom/android/settings/SecuritySettings;->mSubscriptionManager:Landroid/telephony/SubscriptionManager;
    ...
    iput-object v4, p0, Lcom/android/settings/SecuritySettings;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    iput-object v4, p0, Lcom/android/settings/SecuritySettings;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    iput-object v4, p0, Lcom/android/settings/SecuritySettings;->mChooseLockSettingsHelper:Lcom/android/settings/ChooseLockSettingsHelper;
    ...
    :cond_3
    invoke-virtual {p0}, Lcom/android/settings/SecuritySettings;->getArguments()Landroid/os/Bundle;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v7}, Lcom/android/settings/ChooseLockSettingsHelper;->cmUtils()Lorg/cyanogenmod/internal/util/CmLockPatternUtils;
    ...
    sget v9, Lcom/android/settings/SecuritySettings;->MY_USER_ID:I
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 814
    iget-object v0, p0, Lcom/android/settings/SecuritySettings;->mLockscreenDisabledPreference:Landroid/preference/Preference;
...
.method public onResume()V
    ...
    invoke-virtual {v2}, Lcom/android/settings/ChooseLockSettingsHelper;->cmUtils()Lorg/cyanogenmod/internal/util/CmLockPatternUtils;

    move-result-object v0

    .line 756
    .local v0, "cmLockPatternUtils":Lorg/cyanogenmod/internal/util/CmLockPatternUtils;
    iget-object v2, p0, Lcom/android/settings/SecuritySettings;->mDirectlyShow:Landroid/preference/SwitchPreference;
    ...
    .line 762
    :cond_1
    iget-object v2, p0, Lcom/android/settings/SecuritySettings;->mVisibleErrorPattern:Landroid/preference/SwitchPreference;
    ...
    .line 765
    :cond_2
    iget-object v2, p0, Lcom/android/settings/SecuritySettings;->mVisibleDots:Landroid/preference/SwitchPreference;
