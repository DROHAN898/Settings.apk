...
.method static synthetic -get1(Lcom/android/settings/applications/AppOpsDetails;)Landroid/content/pm/PackageInfo;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/applications/AppOpsDetails;->mPackageInfo:Landroid/content/pm/PackageInfo;

    return-object v0
.end method

.method static synthetic -get2(Lcom/android/settings/applications/AppOpsDetails;)Landroid/net/NetworkPolicyManager;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/applications/AppOpsDetails;->mPolicyManager:Landroid/net/NetworkPolicyManager;
...
.method private addInternetSwitch(I)V
    ...
    .line 292
    iget-object v2, p0, Lcom/android/settings/applications/AppOpsDetails;->mInflater:Landroid/view/LayoutInflater;

    .line 293
    iget-object v3, p0, Lcom/android/settings/applications/AppOpsDetails;->mOperationsSection:Landroid/widget/LinearLayout;
    ...
    iget-object v2, p0, Lcom/android/settings/applications/AppOpsDetails;->mOperationsSection:Landroid/widget/LinearLayout;
    ...
    iget-object v2, p0, Lcom/android/settings/applications/AppOpsDetails;->mPolicyManager:Landroid/net/NetworkPolicyManager;
    ...
    invoke-direct {v2, p0, p1}, Lcom/android/settings/applications/AppOpsDetails$3;-><init>(Lcom/android/settings/applications/AppOpsDetails;I)V
...
.method private refreshUi()Z
    ...
    sget-object v30, Lcom/android/settings/applications/AppOpsState;->ALL_TEMPLATES:[Lcom/android/settings/applications/AppOpsState$OpsTemplate;
    ...
    .line 175
    .local v26, "tpl":Lcom/android/settings/applications/AppOpsState$OpsTemplate;
    if-eqz v13, :cond_3

    sget-object v28, Lcom/android/settings/applications/AppOpsState;->SU_TEMPLATE:Lcom/android/settings/applications/AppOpsState$OpsTemplate;
    ...
    .end local v26    # "tpl":Lcom/android/settings/applications/AppOpsState$OpsTemplate;
    :catch_0
    move-exception v6
    ...
    .restart local v26    # "tpl":Lcom/android/settings/applications/AppOpsState$OpsTemplate;
    :cond_3
    move-object/from16 v0, p0
    ...
    .line 180
    .local v7, "entries":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings/applications/AppOpsState$AppOpEntry;>;"
    ...
    check-cast v8, Lcom/android/settings/applications/AppOpsState$AppOpEntry;

    .line 181
    .local v8, "entry":Lcom/android/settings/applications/AppOpsState$AppOpEntry;
    const/16 v28, 0x0

    move/from16 v0, v28

    invoke-virtual {v8, v0}, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->getOpEntry(I)Landroid/app/AppOpsManager$OpEntry;
    ...
    invoke-virtual {v8}, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->getPackageOps()Landroid/app/AppOpsManager$PackageOps;
    ...
    invoke-virtual {v8, v0}, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->getSwitchText(Lcom/android/settings/applications/AppOpsState;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v8, v0}, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->getCountsText(Landroid/content/res/Resources;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v8, v0, v1}, Lcom/android/settings/applications/AppOpsState$AppOpEntry;->getTimeText(Landroid/content/res/Resources;Z)Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, v15}, Lcom/android/settings/applications/AppOpsDetails;->modeToPosition(I)I
    ...
    .line 235
    new-instance v28, Lcom/android/settings/applications/AppOpsDetails$1;
    ...
    invoke-direct {v0, v1, v2, v8}, Lcom/android/settings/applications/AppOpsDetails$1;-><init>(Lcom/android/settings/applications/AppOpsDetails;ILcom/android/settings/applications/AppOpsState$AppOpEntry;)V
    ...
    .line 257
    new-instance v28, Lcom/android/settings/applications/AppOpsDetails$2;
    ...
    invoke-direct {v0, v1, v2, v8}, Lcom/android/settings/applications/AppOpsDetails$2;-><init>(Lcom/android/settings/applications/AppOpsDetails;ILcom/android/settings/applications/AppOpsState$AppOpEntry;)V
    ...
    .line 275
    .end local v7    # "entries":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings/applications/AppOpsState$AppOpEntry;>;"
    .end local v8    # "entry":Lcom/android/settings/applications/AppOpsState$AppOpEntry;
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/applications/AppOpsDetails;->addInternetSwitch(I)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/applications/AppOpsDetails;->mPolicyManager:Landroid/net/NetworkPolicyManager;
