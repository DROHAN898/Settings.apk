...
.method private drawAlphaPanel(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mVal:F
    ...
    sget v3, Lcom/android/settings/notificationlight/ColorPickerView;->mDensity:F
    ...
    .line 328
    :cond_2
    sget v0, Lcom/android/settings/notificationlight/ColorPickerView;->mDensity:F
...
.method private moveTrackersIfNeeded(Landroid/view/MotionEvent;)Z
    ...
    .line 530
    iget-object v4, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mStartTouchPoint:Landroid/graphics/Point;
    ...
    .line 537
    .local v2, "startY":I
    iget-object v4, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mHueRect:Landroid/graphics/RectF;
    ...
    .line 541
    :cond_2
    iget-object v4, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mSatValRect:Landroid/graphics/RectF;
    ...
    .line 542
    iput v7, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mLastTouchedPanel:I
    ...
    invoke-direct {p0, v4, v5}, Lcom/android/settings/notificationlight/ColorPickerView;->pointToSatVal(FF)[F
...
.method private setUpAlphaRect()V
    ...
    sget v6, Lcom/android/settings/notificationlight/ColorPickerView;->mDensity:F
...
.method public getColor()I
    ...
    iget v2, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mSat:F

    const/4 v3, 0x1

    aput v2, v1, v3

    iget v2, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mVal:F
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 516
    iget-object v1, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mListener:Lcom/android/settings/notificationlight/ColorPickerView$OnColorChangedListener;
    ...
    iget v2, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mAlpha:I
    ...
    .line 518
    iget v4, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mHue:F

    const/4 v5, 0x0

    aput v4, v3, v5

    iget v4, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mSat:F

    aput v4, v3, v6

    iget v4, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mVal:F
    ...
    invoke-interface {v1, v2}, Lcom/android/settings/notificationlight/ColorPickerView$OnColorChangedListener;->onColorChanged(I)V
    ...
    iput-object v1, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mStartTouchPoint:Landroid/graphics/Point;
...
.method public onTrackballEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 436
    iget v7, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mLastTouchedPanel:I
    ...
    .line 485
    iget-object v7, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mListener:Lcom/android/settings/notificationlight/ColorPickerView$OnColorChangedListener;
    ...
    .line 487
    iget v10, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mHue:F

    aput v10, v9, v13

    iget v10, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mSat:F

    const/4 v11, 0x1

    aput v10, v9, v11

    iget v10, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mVal:F
    ...
    invoke-interface {v7, v8}, Lcom/android/settings/notificationlight/ColorPickerView$OnColorChangedListener;->onColorChanged(I)V
    ...
    .line 440
    :pswitch_0
    iget v7, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mSat:F
    ...
    .line 441
    .local v2, "sat":F
    iget v7, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mVal:F
    ...
    .end local v4    # "val":F
    :pswitch_1
    iget v7, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mHue:F
    ...
    .end local v1    # "hue":F
    :pswitch_2
    iget-boolean v7, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mShowAlphaPanel:Z
    ...
    .line 471
    :cond_9
    iget v7, p0, Lcom/android/settings/notificationlight/ColorPickerView;->mAlpha:I
