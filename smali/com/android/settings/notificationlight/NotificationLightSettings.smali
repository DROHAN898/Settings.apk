...
.field private mAutoGenerateColors:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;

.field private mCallPref:Lcom/android/settings/notificationlight/ApplicationLightPreference;

.field private mCustomEnabledPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;
...
.field private mMultipleLedsEnabledPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;
...
.field private mScreenOnLightsPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;

.field private mVoicemailPref:Lcom/android/settings/notificationlight/ApplicationLightPreference;


# direct methods
.method static synthetic -wrap0(Lcom/android/settings/notificationlight/NotificationLightSettings;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic -wrap1(Lcom/android/settings/notificationlight/NotificationLightSettings;Ljava/lang/String;)V
    .locals 0
    .param p1, "packageName"    # Ljava/lang/String;
...
.method private addCustomApplicationPref(Ljava/lang/String;)V
    ...
    check-cast v1, Lcom/android/settings/notificationlight/NotificationLightSettings$Package;

    .line 336
    .local v1, "pkg":Lcom/android/settings/notificationlight/NotificationLightSettings$Package;
    if-nez v1, :cond_0

    .line 337
    invoke-direct {p0, p1}, Lcom/android/settings/notificationlight/NotificationLightSettings;->getInitialColorForPackage(Ljava/lang/String;)I

    move-result v0

    .line 338
    .local v0, "color":I
    new-instance v1, Lcom/android/settings/notificationlight/NotificationLightSettings$Package;

    .end local v1    # "pkg":Lcom/android/settings/notificationlight/NotificationLightSettings$Package;
    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iget v3, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mDefaultLedOn:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    iget v4, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mDefaultLedOff:I

    invoke-static {v4}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v4

    invoke-direct {v1, p1, v2, v3, v4}, Lcom/android/settings/notificationlight/NotificationLightSettings$Package;-><init>(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V

    .line 339
    .restart local v1    # "pkg":Lcom/android/settings/notificationlight/NotificationLightSettings$Package;
    iget-object v2, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackages:Ljava/util/Map;
...
.method private getInitialColorForPackage(Ljava/lang/String;)I
    ...
    iget-boolean v4, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mMultiColorLed:Z
    ...
    .line 325
    :try_start_0
    iget-object v4, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackageManager:Landroid/content/pm/PackageManager;
...
.method private parsePackageList()Z
    ...
    iget-object v5, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackageList:Ljava/lang/String;
    ...
    .line 360
    :cond_0
    iput-object v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackageList:Ljava/lang/String;
    ...
    .line 369
    :cond_2
    invoke-static {v2}, Lcom/android/settings/notificationlight/NotificationLightSettings$Package;->fromString(Ljava/lang/String;)Lcom/android/settings/notificationlight/NotificationLightSettings$Package;
    ...
    .line 371
    iget-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackages:Ljava/util/Map;

    iget-object v7, v3, Lcom/android/settings/notificationlight/NotificationLightSettings$Package;->name:Ljava/lang/String;
    ...
    .end local v3    # "pkg":Lcom/android/settings/notificationlight/NotificationLightSettings$Package;
    :cond_3
    const/4 v4, 0x1
...
.method private refreshCustomApplicationPrefs()V
    ...
    .line 283
    :cond_0
    iget-object v9, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mApplicationPrefList:Landroid/preference/PreferenceGroup;
    ...
    .line 286
    iget-object v9, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackages:Ljava/util/Map;
    ...
    .local v3, "pkg":Lcom/android/settings/notificationlight/NotificationLightSettings$Package;
    :try_start_0
    iget-object v9, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackageManager:Landroid/content/pm/PackageManager;

    iget-object v10, v3, Lcom/android/settings/notificationlight/NotificationLightSettings$Package;->name:Ljava/lang/String;
    ...
    new-instance v6, Lcom/android/settings/notificationlight/ApplicationLightPreference;

    iget-object v9, v3, Lcom/android/settings/notificationlight/NotificationLightSettings$Package;->color:Ljava/lang/Integer;

    invoke-virtual {v9}, Ljava/lang/Integer;->intValue()I

    move-result v9

    iget-object v10, v3, Lcom/android/settings/notificationlight/NotificationLightSettings$Package;->timeon:Ljava/lang/Integer;

    invoke-virtual {v10}, Ljava/lang/Integer;->intValue()I

    move-result v10

    iget-object v11, v3, Lcom/android/settings/notificationlight/NotificationLightSettings$Package;->timeoff:Ljava/lang/Integer;

    invoke-virtual {v11}, Ljava/lang/Integer;->intValue()I

    move-result v11

    invoke-direct {v6, v0, v9, v10, v11}, Lcom/android/settings/notificationlight/ApplicationLightPreference;-><init>(Landroid/content/Context;III)V

    .line 293
    .local v6, "pref":Lcom/android/settings/notificationlight/ApplicationLightPreference;
    iget-object v9, v3, Lcom/android/settings/notificationlight/NotificationLightSettings$Package;->name:Ljava/lang/String;

    invoke-virtual {v6, v9}, Lcom/android/settings/notificationlight/ApplicationLightPreference;->setKey(Ljava/lang/String;)V

    .line 294
    iget-object v9, v2, Landroid/content/pm/PackageInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    iget-object v10, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {v6, v9}, Lcom/android/settings/notificationlight/ApplicationLightPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v6, v9}, Lcom/android/settings/notificationlight/ApplicationLightPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 296
    const/4 v9, 0x0

    invoke-virtual {v6, v9}, Lcom/android/settings/notificationlight/ApplicationLightPreference;->setPersistent(Z)V

    .line 297
    invoke-virtual {v6, p0}, Lcom/android/settings/notificationlight/ApplicationLightPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
    ...
    .end local v6    # "pref":Lcom/android/settings/notificationlight/ApplicationLightPreference;
    :catch_0
    move-exception v1
...
.method private refreshDefault()V
    ...
    :cond_1
    iget-boolean v10, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mLedCanPulse:Z

    if-nez v10, :cond_2

    iget-boolean v10, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mMultiColorLed:Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings/notificationlight/NotificationLightSettings;->addPreferencesFromResource(I)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/notificationlight/NotificationLightSettings;->getContext()Landroid/content/Context;
    ...
    .line 108
    iput v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mDefaultColor:I
    ...
    iput v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mDefaultLedOn:I
    ...
    iput v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mDefaultLedOff:I
    ...
    iput-boolean v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mLedCanPulse:Z
    ...
    iput-boolean v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mMultiColorLed:Z

    .line 120
    const-string/jumbo v6, "notification_light_pulse"

    invoke-virtual {p0, v6}, Lcom/android/settings/notificationlight/NotificationLightSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v6

    .line 119
    check-cast v6, Lcom/android/settings/cyanogenmod/SystemSettingSwitchPreference;

    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mEnabledPref:Lcom/android/settings/cyanogenmod/SystemSettingSwitchPreference;

    .line 121
    iget-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mEnabledPref:Lcom/android/settings/cyanogenmod/SystemSettingSwitchPreference;

    invoke-virtual {v6, p0}, Lcom/android/settings/cyanogenmod/SystemSettingSwitchPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
    ...
    check-cast v6, Lcom/android/settings/notificationlight/ApplicationLightPreference;

    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mDefaultPref:Lcom/android/settings/notificationlight/ApplicationLightPreference;
    ...
    .line 125
    check-cast v6, Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;

    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mAutoGenerateColors:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;
    ...
    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mNotificationLedBrightnessPref:Landroid/preference/PreferenceScreen;
    ...
    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mMultipleLedsEnabledPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;
    ...
    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mScreenOnLightsPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;

    .line 135
    iget-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mScreenOnLightsPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;

    invoke-virtual {v6, p0}, Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
    ...
    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mCustomEnabledPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;
    ...
    .line 140
    iget-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mNotificationLedBrightnessPref:Landroid/preference/PreferenceScreen;
    ...
    .line 145
    iget-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mMultipleLedsEnabledPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;

    invoke-virtual {v0, v6}, Landroid/preference/PreferenceGroup;->removePreference(Landroid/preference/Preference;)Z

    .line 149
    :goto_1
    iget-boolean v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mLedCanPulse:Z

    if-nez v6, :cond_0

    iget-boolean v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mMultiColorLed:Z

    if-eqz v6, :cond_5

    .line 153
    :cond_0
    iget-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mCustomEnabledPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;

    invoke-virtual {v6, p0}, Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 154
    iget-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mDefaultPref:Lcom/android/settings/notificationlight/ApplicationLightPreference;
    ...
    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mCallPref:Lcom/android/settings/notificationlight/ApplicationLightPreference;

    .line 164
    iget-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mCallPref:Lcom/android/settings/notificationlight/ApplicationLightPreference;
    ...
    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mVoicemailPref:Lcom/android/settings/notificationlight/ApplicationLightPreference;

    .line 167
    iget-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mVoicemailPref:Lcom/android/settings/notificationlight/ApplicationLightPreference;
    ...
    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mApplicationPrefList:Landroid/preference/PreferenceGroup;

    .line 174
    iget-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mApplicationPrefList:Landroid/preference/PreferenceGroup;
    ...
    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackageManager:Landroid/content/pm/PackageManager;

    .line 179
    new-instance v6, Lcom/android/settings/cyanogenmod/PackageListAdapter;

    invoke-virtual {p0}, Lcom/android/settings/notificationlight/NotificationLightSettings;->getActivity()Landroid/app/Activity;

    move-result-object v7

    invoke-direct {v6, v7}, Lcom/android/settings/cyanogenmod/PackageListAdapter;-><init>(Landroid/content/Context;)V

    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackageAdapter:Lcom/android/settings/cyanogenmod/PackageListAdapter;
    ...
    iput-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackages:Ljava/util/Map;

    .line 182
    const/4 v6, 0x1

    invoke-virtual {p0, v6}, Lcom/android/settings/notificationlight/NotificationLightSettings;->setHasOptionsMenu(Z)V
    ...
    .line 186
    iget-object v6, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mAutoGenerateColors:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings/notificationlight/NotificationLightSettings;->removePreference(Ljava/lang/String;)V
...
.method public onItemLongClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)Z
    ...
    invoke-direct {v3, p0, v1}, Lcom/android/settings/notificationlight/NotificationLightSettings$1;-><init>(Lcom/android/settings/notificationlight/NotificationLightSettings;Landroid/preference/Preference;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 501
    :pswitch_0
    invoke-virtual {p0, v1}, Lcom/android/settings/notificationlight/NotificationLightSettings;->showDialog(I)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mCustomEnabledPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;
    ...
    .line 469
    :cond_1
    iget-object v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mMultipleLedsEnabledPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;

    if-eq p1, v1, :cond_0

    .line 470
    iget-object v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mNotificationLedBrightnessPref:Landroid/preference/PreferenceScreen;

    if-eq p1, v1, :cond_0

    .line 471
    iget-object v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mScreenOnLightsPref:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;

    if-eq p1, v1, :cond_0

    .line 472
    iget-object v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mAutoGenerateColors:Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    invoke-virtual {v1}, Lcom/android/settings/cyanogenmod/SystemSettingSwitchPreference;->isChecked()Z
    ...
    invoke-virtual {v1}, Lcom/android/settings/cyanogenmod/CMSystemSettingSwitchPreference;->isChecked()Z
