...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/settings/notificationlight/LightSettingsDialog$1;,
        Lcom/android/settings/notificationlight/LightSettingsDialog$2;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/android/settings/notificationlight/LightSettingsDialog;)Landroid/view/LayoutInflater;
    .locals 1
...
.method static synthetic -get1(Lcom/android/settings/notificationlight/LightSettingsDialog;)Landroid/widget/Spinner;
    .locals 1
...
.method static synthetic -get2(Lcom/android/settings/notificationlight/LightSettingsDialog;)Landroid/widget/Spinner;
    .locals 1
...
.method static synthetic -wrap0(Lcom/android/settings/notificationlight/LightSettingsDialog;)V
    .locals 0
...
.method private setUp(IIIZ)V
    ...
    iput-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mInflater:Landroid/view/LayoutInflater;

    .line 132
    iget-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mInflater:Landroid/view/LayoutInflater;
    ...
    check-cast v3, Lcom/android/settings/notificationlight/ColorPickerView;

    iput-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mColorPicker:Lcom/android/settings/notificationlight/ColorPickerView;
    ...
    iput-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mColorPanel:Landroid/widget/LinearLayout;
    ...
    iput-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mHexColorInput:Landroid/widget/EditText;
    ...
    check-cast v3, Lcom/android/settings/notificationlight/ColorPanelView;

    iput-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mNewColor:Lcom/android/settings/notificationlight/ColorPanelView;
    ...
    iput-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mLightsDialogDivider:Landroid/view/View;
    ...
    iput-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mPulseSpeedOn:Landroid/widget/Spinner;
    ...
    iput-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mPulseSpeedOff:Landroid/widget/Spinner;
    ...
    invoke-virtual {v3, p0}, Lcom/android/settings/notificationlight/ColorPickerView;->setOnColorChangedListener(Lcom/android/settings/notificationlight/ColorPickerView$OnColorChangedListener;)V

    .line 143
    iget-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mColorPicker:Lcom/android/settings/notificationlight/ColorPickerView;

    invoke-virtual {v3, p1, v8}, Lcom/android/settings/notificationlight/ColorPickerView;->setColor(IZ)V
    ...
    .line 148
    invoke-direct {v1, p0, v5, v6, v3}, Lcom/android/settings/notificationlight/LightSettingsDialog$PulseSpeedAdapter;-><init>(Lcom/android/settings/notificationlight/LightSettingsDialog;IILjava/lang/Integer;)V

    .line 152
    .local v1, "pulseSpeedAdapter":Lcom/android/settings/notificationlight/LightSettingsDialog$PulseSpeedAdapter;
    iget-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mPulseSpeedOn:Landroid/widget/Spinner;
    ...
    iget-object v5, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mPulseSelectionListener:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    iget-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mPulseSpeedOff:Landroid/widget/Spinner;
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/notificationlight/LightSettingsDialog;->setTitle(I)V

    .line 173
    iget-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    invoke-virtual {v3, v7}, Lcom/android/settings/notificationlight/ColorPickerView;->setVisibility(I)V

    .line 175
    iget-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mColorPanel:Landroid/widget/LinearLayout;

    invoke-virtual {v3, v7}, Landroid/widget/LinearLayout;->setVisibility(I)V

    .line 176
    iget-object v3, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mLightsDialogDivider:Landroid/view/View;

    invoke-virtual {v3, v7}, Landroid/view/View;->setVisibility(I)V

    .line 179
    :cond_0
    iput-boolean v8, p0, Lcom/android/settings/notificationlight/LightSettingsDialog;->mReadyForLed:Z
...
.method public afterTextChanged(Landroid/text/Editable;)V
    ...
    invoke-virtual {v3, v0}, Lcom/android/settings/notificationlight/ColorPickerView;->setColor(I)V
    ...
    invoke-virtual {v3, v0}, Lcom/android/settings/notificationlight/ColorPanelView;->setColor(I)V
    ...
    invoke-interface {v3, v0}, Lcom/android/settings/notificationlight/ColorPickerView$OnColorChangedListener;->onColorChanged(I)V
    :try_end_0
