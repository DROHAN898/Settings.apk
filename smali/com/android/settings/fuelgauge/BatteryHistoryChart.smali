...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, v1, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatteryBackgroundPaint:Landroid/graphics/Paint;
    ...
    iput-object v0, v1, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatLevelPath:Landroid/graphics/Path;
    ...
    iget-object v0, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatteryBackgroundPaint:Landroid/graphics/Paint;
    ...
    sget-object v18, Lcom/android/settings/Utils;->BADNESS_COLORS:[I
    ...
    new-instance v13, Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;

    invoke-direct {v13}, Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;-><init>()V

    .line 424
    .local v13, "mainTextAttrs":Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;
    ...
    invoke-virtual {v13, v0, v5, v1}, Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;->retrieve(Landroid/content/Context;Landroid/content/res/TypedArray;I)V
    ...
    iput-object v0, v13, Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;->textColor:Landroid/content/res/ColorStateList;
    ...
    .line 458
    :pswitch_6
    iget v0, v13, Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;->textSize:I
    ...
    iput v0, v13, Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;->textSize:I
    ...
    .line 463
    :pswitch_7
    iget v0, v13, Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;->typefaceIndex:I
    ...
    iput v0, v13, Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;->typefaceIndex:I
    ...
    .line 468
    :pswitch_8
    iget v0, v13, Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;->styleIndex:I
    ...
    iput v0, v13, Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;->styleIndex:I
    ...
    invoke-virtual {v13, v0, v1}, Lcom/android/settings/fuelgauge/BatteryHistoryChart$TextAttrs;->apply(Landroid/content/Context;Landroid/text/TextPaint;)V
...
.method drawChart(Landroid/graphics/Canvas;II)V
    ...
    iget-object v2, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatLevelPath:Landroid/graphics/Path;
    ...
    iget-object v3, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatteryBackgroundPaint:Landroid/graphics/Paint;
    ...
    iget-object v2, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockChargeLabelString:Ljava/lang/String;
    ...
    iget v4, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mHeaderTextDescent:I

    move-object/from16 v0, p0

    iget v5, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mHeaderTextAscent:I
...
.method finishCurLevelPath(IIIILandroid/graphics/Path;ILandroid/graphics/Path;)V
    ...
    iget v1, p0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mLevelTop:I
...
.method finishPaths(IIIIILandroid/graphics/Path;IZZZZZZZLandroid/graphics/Path;)V
    ...
    .line 767
    invoke-virtual/range {v0 .. v7}, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->finishCurLevelPath(IIIILandroid/graphics/Path;ILandroid/graphics/Path;)V
    ...
    .line 778
    iget-object v0, p0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mFlashlightOnPath:Landroid/graphics/Path;

    int-to-float v1, p1

    iget v2, p0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mFlashlightOnOffset:I
    ...
    .line 781
    iget-object v0, p0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mCameraOnPath:Landroid/graphics/Path;

    int-to-float v1, p1

    iget v2, p0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mCameraOnOffset:I
    ...
    .line 787
    iget-object v0, p0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mCpuRunningPath:Landroid/graphics/Path;

    int-to-float v1, p1

    iget v2, p0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mCpuRunningOffset:I
    ...
    invoke-virtual {v0, p1}, Lcom/android/settings/fuelgauge/BatteryHistoryChart$ChartData;->finish(I)V
...
.method protected onMeasure(II)V
    ...
    .line 756
    iget-boolean v1, p0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatterySupported:Z
...
.method protected onSizeChanged(IIII)V
    ...
    iget-boolean v4, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatterySupported:Z
    ...
    iget-object v4, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatLevelPath:Landroid/graphics/Path;
    ...
    iget-wide v0, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockStartWallTime:J
    ...
    iget-wide v0, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockEndDataWallTime:J
    ...
    iget-object v4, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockStats:Landroid/os/BatteryStats;
    ...
    iget-object v10, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatLevelPath:Landroid/graphics/Path;
    ...
    invoke-virtual/range {v20 .. v27}, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->finishCurLevelPath(IIIILandroid/graphics/Path;ILandroid/graphics/Path;)V
    ...
    iget v6, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatteryLevel:I
...
.method setDockStats(Landroid/os/BatteryStats;Landroid/content/Intent;)V
    ...
    iput-object v0, v1, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockStats:Landroid/os/BatteryStats;
    ...
    iget-object v0, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockStats:Landroid/os/BatteryStats;
    ...
    iput-wide v0, v2, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockStatsPeriod:J
    ...
    invoke-static/range {v22 .. v22}, Lcom/android/settings/Utils;->getDockBatteryLevel(Landroid/content/Intent;)I
    ...
    iput v0, v1, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatteryLevel:I

    .line 666
    move-object/from16 v0, p0

    iget v0, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockBatteryLevel:I
    ...
    iput-boolean v0, v1, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockDischarging:Z
    ...
    iput-object v4, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockChargeLabelString:Ljava/lang/String;
    ...
    iput-wide v0, v2, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockHistStart:J
    ...
    iput-wide v0, v2, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockStartWallTime:J
    ...
    iput-wide v0, v2, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockHistDataEnd:J
    ...
    .line 682
    invoke-static/range {v22 .. v23}, Lcom/android/settings/Utils;->getDockBatteryStatus(Landroid/content/res/Resources;Landroid/content/Intent;)Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockChargeLabelString:Ljava/lang/String;
    ...
    iget-wide v0, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockHistDataEnd:J
    ...
    iput-wide v0, v2, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockHistEnd:J
    ...
    iput-wide v0, v2, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockEndDataWallTime:J
    ...
    iput-wide v0, v2, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockEndWallTime:J

    .line 738
    move-object/from16 v0, p0

    iput v8, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockNumHist:I

    .line 739
    move-object/from16 v0, p0

    iget-wide v0, v0, Lcom/android/settings/fuelgauge/BatteryHistoryChart;->mDockHistEnd:J
