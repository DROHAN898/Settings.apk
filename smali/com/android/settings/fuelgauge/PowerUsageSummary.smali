...
# direct methods
.method static synthetic -wrap0(Lcom/android/settings/fuelgauge/PowerUsageSummary;)Landroid/content/ContentResolver;
    .locals 1
...
.method public constructor <init>()V
    ...
    .line 106
    iput v1, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mNumPerfProfiles:I
...
.method private refreshBatterySaverOptions()V
    ...
    .line 361
    iget-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatterySaverPref:Landroid/preference/SwitchPreference;
    ...
    iget-boolean v2, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatteryPluggedIn:Z
...
.method private resetStats()V
    ...
    .line 345
    new-instance v2, Lcom/android/settings/fuelgauge/PowerUsageSummary$3;

    invoke-direct {v2, p0}, Lcom/android/settings/fuelgauge/PowerUsageSummary$3;-><init>(Lcom/android/settings/fuelgauge/PowerUsageSummary;)V
...
.method private updatePerformanceSummary()V
    ...
    .prologue
    .line 475
    iget-object v5, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerf:Lcyanogenmod/power/PerformanceManager;
    ...
    iget-object v5, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfileValues:[Ljava/lang/String;
    ...
    .line 481
    iget-object v5, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfileEntries:[Ljava/lang/String;
    ...
    .line 487
    :cond_1
    iget-object v5, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfilePref:Landroid/preference/ListPreference;
...
.method private updatePerformanceValue()V
    ...
    iget-object v1, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerf:Lcyanogenmod/power/PerformanceManager;
    ...
    .line 495
    iget-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerAppProfiles:Landroid/preference/SwitchPreference;

    .line 496
    iget-object v1, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerf:Lcyanogenmod/power/PerformanceManager;

    iget-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerf:Lcyanogenmod/power/PerformanceManager;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/fuelgauge/PowerUsageSummary;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroid/os/PowerManager;

    iput-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPowerManager:Landroid/os/PowerManager;
    ...
    iput-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerf:Lcyanogenmod/power/PerformanceManager;

    .line 138
    const v4, 0x7f08003d

    invoke-virtual {p0, v4}, Lcom/android/settings/fuelgauge/PowerUsageSummary;->addPreferencesFromResource(I)V

    .line 139
    const-string/jumbo v4, "battery_history"

    invoke-virtual {p0, v4}, Lcom/android/settings/fuelgauge/PowerUsageSummary;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v4

    check-cast v4, Lcom/android/settings/fuelgauge/BatteryHistoryPreference;

    iput-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mHistPref:Lcom/android/settings/fuelgauge/BatteryHistoryPreference;
    ...
    iput-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mAppListGroup:Landroid/preference/PreferenceGroup;
    ...
    iput-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatterySaverPref:Landroid/preference/SwitchPreference;

    .line 143
    iget-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerf:Lcyanogenmod/power/PerformanceManager;

    invoke-virtual {v4}, Lcyanogenmod/power/PerformanceManager;->getNumberOfProfiles()I

    move-result v4

    iput v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mNumPerfProfiles:I
    ...
    iput-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfilePref:Landroid/preference/ListPreference;
    ...
    iput-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerAppProfiles:Landroid/preference/SwitchPreference;

    .line 146
    iget v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mNumPerfProfiles:I
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/fuelgauge/PowerUsageSummary;->removePreference(Ljava/lang/String;)V
    ...
    .line 149
    iput-object v6, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfilePref:Landroid/preference/ListPreference;

    .line 150
    iput-object v6, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerAppProfiles:Landroid/preference/SwitchPreference;

    .line 177
    :goto_0
    new-instance v4, Lcom/android/settings/fuelgauge/PowerUsageSummary$PerformanceProfileObserver;

    new-instance v5, Landroid/os/Handler;

    invoke-direct {v5}, Landroid/os/Handler;-><init>()V

    invoke-direct {v4, p0, v5}, Lcom/android/settings/fuelgauge/PowerUsageSummary$PerformanceProfileObserver;-><init>(Lcom/android/settings/fuelgauge/PowerUsageSummary;Landroid/os/Handler;)V

    iput-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerformanceProfileObserver:Lcom/android/settings/fuelgauge/PowerUsageSummary$PerformanceProfileObserver;
    ...
    .line 154
    iput-object v6, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatterySaverPref:Landroid/preference/SwitchPreference;
    ...
    iput-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfileEntries:[Ljava/lang/String;
    ...
    iput-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfileValues:[Ljava/lang/String;
    ...
    iget v5, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mNumPerfProfiles:I
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 311
    new-instance v3, Lcom/android/settings/fuelgauge/PowerUsageSummary$2;

    invoke-direct {v3, p0, v9}, Lcom/android/settings/fuelgauge/PowerUsageSummary$2;-><init>(Lcom/android/settings/fuelgauge/PowerUsageSummary;[I)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 237
    iget-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfilePref:Landroid/preference/ListPreference;
...
.method public onResume()V
    ...
    .line 198
    iget-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerformanceProfileObserver:Lcom/android/settings/fuelgauge/PowerUsageSummary$PerformanceProfileObserver;
...
.method protected refreshStats()V
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/fuelgauge/PowerUsageSummary;->sipperCanBePruned(Lcom/android/internal/os/BatterySipper;)Z
    ...
    invoke-virtual {v0, v8}, Lcom/android/settings/fuelgauge/PowerGaugePreference;->setTint(I)V
