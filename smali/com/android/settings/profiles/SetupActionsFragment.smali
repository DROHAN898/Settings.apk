...
.field private mSelectedItem:Lcom/android/settings/profiles/actions/item/Item;
...
.method static synthetic -get0()[I
    ...
    sget-object v0, Lcom/android/settings/profiles/SetupActionsFragment;->DOZE_MAPPING:[I
...
.method static synthetic -get2()[I
    ...
    sget-object v0, Lcom/android/settings/profiles/SetupActionsFragment;->NOTIFICATION_LIGHT_MAPPING:[I

    return-object v0
.end method

.method static synthetic -wrap0(Lcom/android/settings/profiles/SetupActionsFragment;Ljava/lang/String;)Ljava/lang/Object;
    .locals 1
...
.method static synthetic -wrap1(Lcom/android/settings/profiles/SetupActionsFragment;)V
    .locals 0
...
.method static synthetic -wrap2(Lcom/android/settings/profiles/SetupActionsFragment;)V
    .locals 0
...
.method static synthetic -wrap3(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/content/DialogInterface$OnDismissListener;)V
    .locals 0
    .param p1, "listener"    # Landroid/content/DialogInterface$OnDismissListener;

    .prologue
    invoke-virtual {p0, p1}, Lcom/android/settings/profiles/SetupActionsFragment;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    return-void
.end method

.method static synthetic -wrap4(Lcom/android/settings/profiles/SetupActionsFragment;)V
    .locals 0
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/profiles/SetupActionsFragment;->DOZE_MAPPING:[I
    ...
    sput-object v0, Lcom/android/settings/profiles/SetupActionsFragment;->NOTIFICATION_LIGHT_MAPPING:[I
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mLastSelectedPosition:I
...
.method private fillProfileFromCurrentSettings()V
    ...
    .prologue
    .line 426
    new-instance v1, Lcom/android/settings/profiles/SetupActionsFragment$2;

    invoke-direct {v1, p0}, Lcom/android/settings/profiles/SetupActionsFragment$2;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;)V
    ...
    .line 426
    invoke-virtual {v1, v2}, Lcom/android/settings/profiles/SetupActionsFragment$2;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public static fillProfileWithCurrentSettings(Landroid/content/Context;Lcyanogenmod/app/Profile;)V
    ...
    .line 472
    invoke-static {p0}, Lcom/android/settings/cyanogenmod/DeviceUtils;->deviceSupportsMobileData(Landroid/content/Context;)Z
    ...
    .line 489
    invoke-static {p0}, Lcom/android/settings/cyanogenmod/DeviceUtils;->deviceSupportsNfc(Landroid/content/Context;)Z
...
.method private generateConnectionOverrideItem(I)Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    ...
    .prologue
    .line 361
    iget-object v1, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    invoke-direct {v1, p1, v0}, Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;-><init>(ILcyanogenmod/profiles/ConnectionSettings;)V

    return-object v1
.end method

.method private generatePreferredNetworkOverrideItem(I)Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    .locals 3
    .param p1, "subId"    # I
    ...
    invoke-direct {v1, v2, v0}, Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;-><init>(ILcyanogenmod/profiles/ConnectionSettings;)V
...
.method private generateTriggerItem(I)Lcom/android/settings/profiles/actions/item/TriggerItem;
    ...
    invoke-direct {v0, v1, p1}, Lcom/android/settings/profiles/actions/item/TriggerItem;-><init>(Lcyanogenmod/app/Profile;I)V
...
.method private generateVolumeStreamItem(I)Lcom/android/settings/profiles/actions/item/VolumeStreamItem;
    ...
    invoke-direct {v1, p1, v0}, Lcom/android/settings/profiles/actions/item/VolumeStreamItem;-><init>(ILcyanogenmod/profiles/StreamSettings;)V
...
.method private openTriggersFragment(I)V
    ...
    iget-object v3, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;
...
.method private rebuildItemList()V
    ...
    new-instance v9, Lcom/android/settings/profiles/actions/item/Header;

    const v10, 0x7f0c00a5

    invoke-virtual {p0, v10}, Lcom/android/settings/profiles/SetupActionsFragment;->getString(I)Ljava/lang/String;

    move-result-object v10

    invoke-direct {v9, v10}, Lcom/android/settings/profiles/actions/item/Header;-><init>(Ljava/lang/String;)V
    ...
    new-instance v9, Lcom/android/settings/profiles/actions/item/ProfileNameItem;

    iget-object v10, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;

    invoke-direct {v9, v10}, Lcom/android/settings/profiles/actions/item/ProfileNameItem;-><init>(Lcyanogenmod/app/Profile;)V

    invoke-interface {v8, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 206
    iget-boolean v8, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mNewProfileMode:Z
    ...
    invoke-direct {p0, v9}, Lcom/android/settings/profiles/SetupActionsFragment;->generateTriggerItem(I)Lcom/android/settings/profiles/actions/item/TriggerItem;
    ...
    new-instance v9, Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    ...
    invoke-direct {v9, v11, v10}, Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;-><init>(ILcyanogenmod/profiles/ConnectionSettings;)V
    ...
    .line 231
    invoke-virtual {p0}, Lcom/android/settings/profiles/SetupActionsFragment;->getContext()Landroid/content/Context;
    ...
    invoke-direct {p0, v9}, Lcom/android/settings/profiles/SetupActionsFragment;->generatePreferredNetworkOverrideItem(I)Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    ...
    new-instance v9, Lcom/android/settings/profiles/actions/item/RingModeItem;
    ...
    invoke-direct {v9, v10}, Lcom/android/settings/profiles/actions/item/RingModeItem;-><init>(Lcyanogenmod/profiles/RingModeSettings;)V
    ...
    new-instance v9, Lcom/android/settings/profiles/actions/item/AirplaneModeItem;
    ...
    invoke-direct {v9, v10}, Lcom/android/settings/profiles/actions/item/AirplaneModeItem;-><init>(Lcyanogenmod/profiles/AirplaneModeSettings;)V
    ...
    .line 262
    invoke-virtual {p0, v8}, Lcom/android/settings/profiles/SetupActionsFragment;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    new-instance v9, Lcom/android/settings/profiles/actions/item/LockModeItem;

    iget-object v10, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;

    invoke-direct {v9, v10}, Lcom/android/settings/profiles/actions/item/LockModeItem;-><init>(Lcyanogenmod/app/Profile;)V
    ...
    new-instance v9, Lcom/android/settings/profiles/actions/item/BrightnessItem;
    ...
    invoke-direct {v9, v10}, Lcom/android/settings/profiles/actions/item/BrightnessItem;-><init>(Lcyanogenmod/profiles/BrightnessSettings;)V
    ...
    invoke-static {v0}, Lcom/android/settings/Utils;->isDozeAvailable(Landroid/content/Context;)Z
    ...
    new-instance v9, Lcom/android/settings/profiles/actions/item/DozeModeItem;

    iget-object v10, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;

    invoke-direct {v9, v10}, Lcom/android/settings/profiles/actions/item/DozeModeItem;-><init>(Lcyanogenmod/app/Profile;)V
    ...
    new-instance v9, Lcom/android/settings/profiles/actions/item/NotificationLightModeItem;

    iget-object v10, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;

    invoke-direct {v9, v10}, Lcom/android/settings/profiles/actions/item/NotificationLightModeItem;-><init>(Lcyanogenmod/app/Profile;)V
    ...
    iget-object v8, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    iget-object v10, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfileManager:Lcyanogenmod/app/ProfileManager;
    ...
    new-instance v9, Lcom/android/settings/profiles/actions/item/DisabledItem;
    ...
    .line 267
    invoke-direct {v9, v10, v11}, Lcom/android/settings/profiles/actions/item/DisabledItem;-><init>(II)V
    ...
    :cond_a
    iget-object v10, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mItems:Ljava/util/List;

    new-instance v11, Lcom/android/settings/profiles/actions/item/AppGroupItem;

    iget-object v12, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;

    .line 295
    iget-object v13, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfileManager:Lcyanogenmod/app/ProfileManager;
    ...
    .line 294
    invoke-direct {v11, v12, v3, v13}, Lcom/android/settings/profiles/actions/item/AppGroupItem;-><init>(Lcyanogenmod/app/Profile;Lcyanogenmod/app/ProfileGroup;Landroid/app/NotificationGroup;)V
    ...
    new-instance v9, Lcom/android/settings/profiles/actions/item/AppGroupItem;

    iget-object v10, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;

    iget-object v11, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    .line 303
    iget-object v12, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfileManager:Lcyanogenmod/app/ProfileManager;

    .line 304
    iget-object v13, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    .line 302
    invoke-direct {v9, v10, v11, v12}, Lcom/android/settings/profiles/actions/item/AppGroupItem;-><init>(Lcyanogenmod/app/Profile;Lcyanogenmod/app/ProfileGroup;Landroid/app/NotificationGroup;)V

    invoke-interface {v8, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 307
    :cond_c
    iget-object v8, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfileManager:Lcyanogenmod/app/ProfileManager;
    ...
    invoke-direct {v9}, Lcom/android/settings/profiles/actions/item/AppGroupItem;-><init>()V
    ...
    :cond_d
    :goto_4
    iget-object v8, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mAdapter:Lcom/android/settings/profiles/actions/ItemListAdapter;

    invoke-virtual {v8}, Lcom/android/settings/profiles/actions/ItemListAdapter;->notifyDataSetChanged()V
...
.method private requestActiveAppGroupsDialog()V
    ...
    .line 1031
    iget-object v6, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfileManager:Lcyanogenmod/app/ProfileManager;
    ...
    .line 1038
    iget-object v6, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    .line 1041
    :cond_1
    new-instance v4, Lcom/android/settings/profiles/SetupActionsFragment$20;

    invoke-direct {v4, p0, v5}, Lcom/android/settings/profiles/SetupActionsFragment$20;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;[Landroid/app/NotificationGroup;)V
...
.method private requestAirplaneModeDialog(Lcyanogenmod/profiles/AirplaneModeSettings;)Landroid/app/AlertDialog;
    ...
    invoke-direct {v3, p0, p1}, Lcom/android/settings/profiles/SetupActionsFragment$8;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Lcyanogenmod/profiles/AirplaneModeSettings;)V
...
.method private requestConnectionOverrideDialog(Lcyanogenmod/profiles/ConnectionSettings;)Landroid/app/AlertDialog;
    ...
    invoke-static {v3, p1}, Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;->getConnectionTitle(Landroid/content/Context;Lcyanogenmod/profiles/ConnectionSettings;)Ljava/lang/String;
    ...
    .line 862
    new-instance v3, Lcom/android/settings/profiles/SetupActionsFragment$10;

    invoke-direct {v3, p0, p1}, Lcom/android/settings/profiles/SetupActionsFragment$10;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Lcyanogenmod/profiles/ConnectionSettings;)V
...
.method private requestDozeModeDialog()Landroid/app/AlertDialog;
    ...
    .local v3, "i":I
    :goto_0
    sget-object v4, Lcom/android/settings/profiles/SetupActionsFragment;->DOZE_MAPPING:[I
    ...
    iget-object v5, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    .line 662
    new-instance v4, Lcom/android/settings/profiles/SetupActionsFragment$6;

    invoke-direct {v4, p0}, Lcom/android/settings/profiles/SetupActionsFragment$6;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;)V
...
.method private requestFillProfileFromSettingsDialog()Landroid/app/AlertDialog;
    ...
    .line 415
    new-instance v1, Lcom/android/settings/profiles/SetupActionsFragment$1;

    invoke-direct {v1, p0}, Lcom/android/settings/profiles/SetupActionsFragment$1;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;)V
...
.method private requestNotificationLightModeDialog()Landroid/app/AlertDialog;
    ...
    .local v2, "i":I
    :goto_0
    sget-object v4, Lcom/android/settings/profiles/SetupActionsFragment;->NOTIFICATION_LIGHT_MAPPING:[I
    ...
    invoke-direct {v4, p0}, Lcom/android/settings/profiles/SetupActionsFragment$7;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;)V
...
.method private requestProfileName()Landroid/app/AlertDialog;
    ...
    iget-object v4, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    .line 988
    new-instance v5, Lcom/android/settings/profiles/SetupActionsFragment$17;

    invoke-direct {v5, p0, v2}, Lcom/android/settings/profiles/SetupActionsFragment$17;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/widget/EditText;)V
    ...
    invoke-direct {v4, p0, v0}, Lcom/android/settings/profiles/SetupActionsFragment$18;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/app/AlertDialog;)V
    ...
    invoke-direct {v4, p0, v2}, Lcom/android/settings/profiles/SetupActionsFragment$19;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/widget/EditText;)V
...
.method private requestRemoveProfileDialog()Landroid/app/AlertDialog;
    ...
    .prologue
    .line 591
    iget-object v2, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfileManager:Lcyanogenmod/app/ProfileManager;
    ...
    iget-object v2, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    .line 595
    new-instance v2, Lcom/android/settings/profiles/SetupActionsFragment$3;

    invoke-direct {v2, p0}, Lcom/android/settings/profiles/SetupActionsFragment$3;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;)V
    ...
    invoke-virtual {p0, v3, v2}, Lcom/android/settings/profiles/SetupActionsFragment;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 606
    new-instance v2, Lcom/android/settings/profiles/SetupActionsFragment$4;

    invoke-direct {v2, p0}, Lcom/android/settings/profiles/SetupActionsFragment$4;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;)V
...
.method private requestRingModeDialog(Lcyanogenmod/profiles/RingModeSettings;)Landroid/app/AlertDialog;
    ...
    .line 809
    new-instance v4, Lcom/android/settings/profiles/SetupActionsFragment$9;

    invoke-direct {v4, p0, p1, v3}, Lcom/android/settings/profiles/SetupActionsFragment$9;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Lcyanogenmod/profiles/RingModeSettings;[Ljava/lang/String;)V
...
.method private updateProfile()V
    ...
    .prologue
    .line 397
    iget-object v0, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfileManager:Lcyanogenmod/app/ProfileManager;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 761
    iget-object v4, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfileManager:Lcyanogenmod/app/ProfileManager;
    ...
    iput-object v4, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    .line 771
    .local v3, "subId":I
    iget-object v0, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mSelectedItem:Lcom/android/settings/profiles/actions/item/Item;

    check-cast v0, Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;

    .line 772
    .local v0, "connItem":Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    invoke-virtual {v0}, Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;->getSettings()Lcyanogenmod/profiles/ConnectionSettings;
    ...
    .line 784
    iget-object v4, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mAdapter:Lcom/android/settings/profiles/actions/ItemListAdapter;

    invoke-virtual {v4}, Lcom/android/settings/profiles/actions/ItemListAdapter;->notifyDataSetChanged()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    iput-object v0, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mProfileManager:Lcyanogenmod/app/ProfileManager;
    ...
    .line 188
    invoke-virtual {p0, v4}, Lcom/android/settings/profiles/SetupActionsFragment;->setHasOptionsMenu(Z)V
    ...
    .line 191
    invoke-virtual {p0, v4}, Lcom/android/settings/profiles/SetupActionsFragment;->showDialog(I)V
    ...
    .line 194
    iget v0, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mLastSelectedPosition:I

    if-eq v0, v3, :cond_1

    .line 195
    iget-object v0, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mAdapter:Lcom/android/settings/profiles/actions/ItemListAdapter;

    iget v1, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mLastSelectedPosition:I

    invoke-virtual {v0, v1}, Lcom/android/settings/profiles/actions/ItemListAdapter;->getItem(I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/android/settings/profiles/actions/item/Item;

    iput-object v0, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mSelectedItem:Lcom/android/settings/profiles/actions/item/Item;
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    .line 544
    :pswitch_0
    invoke-direct {p0}, Lcom/android/settings/profiles/SetupActionsFragment;->requestFillProfileFromSettingsDialog()Landroid/app/AlertDialog;
    ...
    .line 547
    :pswitch_1
    iget-object v2, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mSelectedItem:Lcom/android/settings/profiles/actions/item/Item;

    check-cast v2, Lcom/android/settings/profiles/actions/item/AirplaneModeItem;

    invoke-virtual {v2}, Lcom/android/settings/profiles/actions/item/AirplaneModeItem;->getSettings()Lcyanogenmod/profiles/AirplaneModeSettings;

    move-result-object v2

    invoke-direct {p0, v2}, Lcom/android/settings/profiles/SetupActionsFragment;->requestAirplaneModeDialog(Lcyanogenmod/profiles/AirplaneModeSettings;)Landroid/app/AlertDialog;
    ...
    check-cast v2, Lcom/android/settings/profiles/actions/item/BrightnessItem;

    invoke-virtual {v2}, Lcom/android/settings/profiles/actions/item/BrightnessItem;->getSettings()Lcyanogenmod/profiles/BrightnessSettings;

    move-result-object v2

    invoke-virtual {p0, v2}, Lcom/android/settings/profiles/SetupActionsFragment;->requestBrightnessDialog(Lcyanogenmod/profiles/BrightnessSettings;)Landroid/app/AlertDialog;
    ...
    .line 553
    :pswitch_3
    invoke-direct {p0}, Lcom/android/settings/profiles/SetupActionsFragment;->requestLockscreenModeDialog()Landroid/app/AlertDialog;
    ...
    .line 556
    :pswitch_4
    invoke-direct {p0}, Lcom/android/settings/profiles/SetupActionsFragment;->requestDozeModeDialog()Landroid/app/AlertDialog;
    ...
    .line 559
    :pswitch_5
    invoke-direct {p0}, Lcom/android/settings/profiles/SetupActionsFragment;->requestNotificationLightModeDialog()Landroid/app/AlertDialog;
    ...
    check-cast v2, Lcom/android/settings/profiles/actions/item/RingModeItem;

    invoke-virtual {v2}, Lcom/android/settings/profiles/actions/item/RingModeItem;->getSettings()Lcyanogenmod/profiles/RingModeSettings;

    move-result-object v2

    invoke-direct {p0, v2}, Lcom/android/settings/profiles/SetupActionsFragment;->requestRingModeDialog(Lcyanogenmod/profiles/RingModeSettings;)Landroid/app/AlertDialog;
    ...
    invoke-direct {p0, v2}, Lcom/android/settings/profiles/SetupActionsFragment;->requestConnectionOverrideDialog(Lcyanogenmod/profiles/ConnectionSettings;)Landroid/app/AlertDialog;
    ...
    .line 569
    .end local v0    # "connItem":Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    :pswitch_8
    iget-object v1, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mSelectedItem:Lcom/android/settings/profiles/actions/item/Item;

    check-cast v1, Lcom/android/settings/profiles/actions/item/VolumeStreamItem;

    .line 570
    .local v1, "volumeItem":Lcom/android/settings/profiles/actions/item/VolumeStreamItem;
    invoke-virtual {v1}, Lcom/android/settings/profiles/actions/item/VolumeStreamItem;->getStreamType()I

    move-result v2

    invoke-virtual {v1}, Lcom/android/settings/profiles/actions/item/VolumeStreamItem;->getSettings()Lcyanogenmod/profiles/StreamSettings;

    move-result-object v3

    invoke-virtual {p0, v2, v3}, Lcom/android/settings/profiles/SetupActionsFragment;->requestVolumeDialog(ILcyanogenmod/profiles/StreamSettings;)Landroid/app/AlertDialog;
    ...
    .line 573
    .end local v1    # "volumeItem":Lcom/android/settings/profiles/actions/item/VolumeStreamItem;
    :pswitch_9
    invoke-direct {p0}, Lcom/android/settings/profiles/SetupActionsFragment;->requestProfileName()Landroid/app/AlertDialog;
    ...
    .line 576
    :pswitch_a
    invoke-direct {p0}, Lcom/android/settings/profiles/SetupActionsFragment;->requestRemoveProfileDialog()Landroid/app/AlertDialog;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    new-instance v2, Lcom/android/settings/profiles/SetupActionsFragment$22;

    invoke-direct {v2, p0}, Lcom/android/settings/profiles/SetupActionsFragment$22;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;)V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    check-cast v4, Lcom/android/settings/profiles/actions/item/Item;

    .line 1095
    .local v4, "itemAtPosition":Lcom/android/settings/profiles/actions/item/Item;
    iput-object v4, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mSelectedItem:Lcom/android/settings/profiles/actions/item/Item;

    .line 1096
    iget-object v5, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mAdapter:Lcom/android/settings/profiles/actions/ItemListAdapter;

    invoke-virtual {v5, v4}, Lcom/android/settings/profiles/actions/ItemListAdapter;->getPosition(Ljava/lang/Object;)I

    move-result v5

    iput v5, p0, Lcom/android/settings/profiles/SetupActionsFragment;->mLastSelectedPosition:I

    .line 1098
    instance-of v5, v4, Lcom/android/settings/profiles/actions/item/AirplaneModeItem;
    ...
    invoke-virtual {p0, v5}, Lcom/android/settings/profiles/SetupActionsFragment;->showDialog(I)V
    ...
    .line 1100
    :cond_1
    instance-of v5, v4, Lcom/android/settings/profiles/actions/item/BrightnessItem;
    ...
    .line 1102
    :cond_2
    instance-of v5, v4, Lcom/android/settings/profiles/actions/item/LockModeItem;
    ...
    .line 1104
    :cond_3
    instance-of v5, v4, Lcom/android/settings/profiles/actions/item/DozeModeItem;
    ...
    .line 1106
    :cond_4
    instance-of v5, v4, Lcom/android/settings/profiles/actions/item/NotificationLightModeItem;
    ...
    .line 1108
    :cond_5
    instance-of v5, v4, Lcom/android/settings/profiles/actions/item/RingModeItem;
    ...
    .line 1110
    :cond_6
    instance-of v5, v4, Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings/profiles/SetupActionsFragment;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v5}, Lcom/android/settings/profiles/SetupActionsFragment;->startActivityForResult(Landroid/content/Intent;I)V
    ...
    .end local v0    # "connItem":Lcom/android/settings/profiles/actions/item/ConnectionOverrideItem;
    :cond_9
    instance-of v5, v4, Lcom/android/settings/profiles/actions/item/VolumeStreamItem;
    ...
    .line 1128
    :cond_a
    instance-of v5, v4, Lcom/android/settings/profiles/actions/item/ProfileNameItem;

    if-eqz v5, :cond_b

    .line 1129
    invoke-virtual {p0, v6}, Lcom/android/settings/profiles/SetupActionsFragment;->showDialog(I)V

    goto/16 :goto_0

    .line 1130
    :cond_b
    instance-of v5, v4, Lcom/android/settings/profiles/actions/item/TriggerItem;
    ...
    .line 1131
    check-cast v3, Lcom/android/settings/profiles/actions/item/TriggerItem;

    .line 1132
    .local v3, "item":Lcom/android/settings/profiles/actions/item/TriggerItem;
    invoke-virtual {v3}, Lcom/android/settings/profiles/actions/item/TriggerItem;->getTriggerType()I

    move-result v5

    invoke-direct {p0, v5}, Lcom/android/settings/profiles/SetupActionsFragment;->openTriggersFragment(I)V

    goto/16 :goto_0

    .line 1133
    .end local v3    # "item":Lcom/android/settings/profiles/actions/item/TriggerItem;
    :cond_c
    instance-of v5, v4, Lcom/android/settings/profiles/actions/item/AppGroupItem;
    ...
    .line 1134
    check-cast v2, Lcom/android/settings/profiles/actions/item/AppGroupItem;

    .line 1135
    .local v2, "item":Lcom/android/settings/profiles/actions/item/AppGroupItem;
    invoke-virtual {v2}, Lcom/android/settings/profiles/actions/item/AppGroupItem;->getGroupUuid()Ljava/util/UUID;
    ...
    .line 1138
    :cond_d
    invoke-direct {p0, v2}, Lcom/android/settings/profiles/SetupActionsFragment;->startProfileGroupActivity(Lcom/android/settings/profiles/actions/item/AppGroupItem;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/profiles/SetupActionsFragment;->showDialog(I)V
    ...
    .line 344
    :pswitch_1
    invoke-virtual {p0, v1}, Lcom/android/settings/profiles/SetupActionsFragment;->showDialog(I)V
...
.method public requestBrightnessDialog(Lcyanogenmod/profiles/BrightnessSettings;)Landroid/app/AlertDialog;
    ...
    .line 946
    new-instance v5, Lcom/android/settings/profiles/SetupActionsFragment$14;

    invoke-direct {v5, p0, v3}, Lcom/android/settings/profiles/SetupActionsFragment$14;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/widget/SeekBar;)V
    ...
    .line 956
    new-instance v5, Lcom/android/settings/profiles/SetupActionsFragment$15;

    invoke-direct {v5, p0, v3, p1, v2}, Lcom/android/settings/profiles/SetupActionsFragment$15;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/widget/SeekBar;Lcyanogenmod/profiles/BrightnessSettings;Landroid/widget/CheckBox;)V
    ...
    .line 968
    new-instance v5, Lcom/android/settings/profiles/SetupActionsFragment$16;

    invoke-direct {v5, p0}, Lcom/android/settings/profiles/SetupActionsFragment$16;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;)V
...
.method public requestVolumeDialog(ILcyanogenmod/profiles/StreamSettings;)Landroid/app/AlertDialog;
    ...
    invoke-direct {v7, p0, v4}, Lcom/android/settings/profiles/SetupActionsFragment$11;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/widget/SeekBar;)V
    ...
    invoke-direct {v7, p0, v4, p2, v3}, Lcom/android/settings/profiles/SetupActionsFragment$12;-><init>(Lcom/android/settings/profiles/SetupActionsFragment;Landroid/widget/SeekBar;Lcyanogenmod/profiles/StreamSettings;Landroid/widget/CheckBox;)V
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings/profiles/SetupActionsFragment;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V
