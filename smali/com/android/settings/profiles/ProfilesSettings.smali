...
# interfaces
.implements Lcom/android/settings/cyanogenmod/CMBaseSystemSettingSwitchBar$SwitchBarChangeCallback;
...
.field private mProfileEnabler:Lcom/android/settings/cyanogenmod/CMBaseSystemSettingSwitchBar;
...
# direct methods
.method static synthetic -get0(Lcom/android/settings/profiles/ProfilesSettings;)Lcyanogenmod/app/ProfileManager;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/profiles/ProfilesSettings;->mProfileManager:Lcyanogenmod/app/ProfileManager;

    return-object v0
.end method

.method static synthetic -wrap0(Lcom/android/settings/profiles/ProfilesSettings;)V
    .locals 0
...
.method static synthetic -wrap1(Lcom/android/settings/profiles/ProfilesSettings;)V
    .locals 0
...
.method private resetAll()V
    ...
    .line 230
    new-instance v1, Lcom/android/settings/profiles/ProfilesSettings$3;

    invoke-direct {v1, p0}, Lcom/android/settings/profiles/ProfilesSettings$3;-><init>(Lcom/android/settings/profiles/ProfilesSettings;)V
...
.method private setSelectedProfile(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/android/settings/profiles/ProfilesSettings;->mProfileManager:Lcyanogenmod/app/ProfileManager;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/profiles/ProfilesSettings;->mProfileManager:Lcyanogenmod/app/ProfileManager;
...
.method public onDestroyView()V
    ...
    .prologue
    .line 184
    iget-object v0, p0, Lcom/android/settings/profiles/ProfilesSettings;->mProfileEnabler:Lcom/android/settings/cyanogenmod/CMBaseSystemSettingSwitchBar;
    ...
    invoke-virtual {v0}, Lcom/android/settings/cyanogenmod/CMBaseSystemSettingSwitchBar;->teardownSwitchBar()V
...
.method public onPause()V
    ...
    invoke-virtual {v0}, Lcom/android/settings/cyanogenmod/CMBaseSystemSettingSwitchBar;->pause()V
...
.method public onResume()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/cyanogenmod/CMBaseSystemSettingSwitchBar;->resume(Landroid/content/Context;)V
...
.method public onStart()V
    ...
    new-instance v0, Lcom/android/settings/cyanogenmod/CMBaseSystemSettingSwitchBar;
    ...
    .line 178
    invoke-direct/range {v0 .. v5}, Lcom/android/settings/cyanogenmod/CMBaseSystemSettingSwitchBar;-><init>(Landroid/content/Context;Lcom/android/settings/widget/SwitchBar;Ljava/lang/String;ZLcom/android/settings/cyanogenmod/CMBaseSystemSettingSwitchBar$SwitchBarChangeCallback;)V

    iput-object v0, p0, Lcom/android/settings/profiles/ProfilesSettings;->mProfileEnabler:Lcom/android/settings/cyanogenmod/CMBaseSystemSettingSwitchBar;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 130
    iget-object v6, p0, Lcom/android/settings/profiles/ProfilesSettings;->mContainer:Landroid/view/ViewGroup;
...
.method public refreshList()V
    ...
    .line 275
    iget-object v6, p0, Lcom/android/settings/profiles/ProfilesSettings;->mProfileManager:Lcyanogenmod/app/ProfileManager;
    ...
    .line 283
    new-instance v2, Lcom/android/settings/profiles/ProfilesPreference;

    invoke-direct {v2, p0, v0}, Lcom/android/settings/profiles/ProfilesPreference;-><init>(Lcom/android/settings/SettingsPreferenceFragment;Landroid/os/Bundle;)V

    .line 284
    .local v2, "ppref":Lcom/android/settings/profiles/ProfilesPreference;
    ...
    invoke-virtual {v2, v10}, Lcom/android/settings/profiles/ProfilesPreference;->setKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v10}, Lcom/android/settings/profiles/ProfilesPreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 286
    invoke-virtual {v2, v7}, Lcom/android/settings/profiles/ProfilesPreference;->setPersistent(Z)V

    .line 287
    invoke-virtual {v2, p0}, Lcom/android/settings/profiles/ProfilesPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 288
    invoke-virtual {v2, v11}, Lcom/android/settings/profiles/ProfilesPreference;->setSelectable(Z)V

    .line 289
    invoke-virtual {v2, v11}, Lcom/android/settings/profiles/ProfilesPreference;->setEnabled(Z)V

    .line 291
    invoke-virtual {v2}, Lcom/android/settings/profiles/ProfilesPreference;->getKey()Ljava/lang/String;
    ...
    .line 292
    invoke-virtual {v2, v11}, Lcom/android/settings/profiles/ProfilesPreference;->setChecked(Z)V
    ...
    .end local v2    # "ppref":Lcom/android/settings/profiles/ProfilesPreference;
