...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 97
    iget-object v3, p0, Lcom/android/settings/profiles/SetupTriggersFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    invoke-virtual {p0, v3, v2}, Lcom/android/settings/profiles/SetupTriggersFragment;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/profiles/SetupTriggersFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    iput-object v0, p0, Lcom/android/settings/profiles/SetupTriggersFragment;->mProfileManager:Lcyanogenmod/app/ProfileManager;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v6, p0, Lcom/android/settings/profiles/SetupTriggersFragment;->mPager:Landroid/support/v4/view/ViewPager;

    .line 115
    new-instance v6, Lcom/android/settings/profiles/TriggerPagerAdapter;
    ...
    invoke-direct {v6, v8, v9}, Lcom/android/settings/profiles/TriggerPagerAdapter;-><init>(Landroid/app/Activity;Landroid/app/FragmentManager;)V

    iput-object v6, p0, Lcom/android/settings/profiles/SetupTriggersFragment;->mAdapter:Lcom/android/settings/profiles/TriggerPagerAdapter;
    ...
    iget-object v8, p0, Lcom/android/settings/profiles/SetupTriggersFragment;->mProfile:Lcyanogenmod/app/Profile;
    ...
    .line 123
    .local v1, "fragments":[Lcom/android/settings/profiles/TriggerPagerAdapter$TriggerFragments;
    array-length v8, v1
    ...
    .line 124
    .local v0, "fragment":Lcom/android/settings/profiles/TriggerPagerAdapter$TriggerFragments;
    invoke-virtual {v0}, Lcom/android/settings/profiles/TriggerPagerAdapter$TriggerFragments;->getFragmentClass()Ljava/lang/Class;

    move-result-object v7

    const-class v9, Lcom/android/settings/profiles/triggers/NfcTriggerFragment;
    ...
    .line 131
    :cond_0
    iget-object v7, p0, Lcom/android/settings/profiles/SetupTriggersFragment;->mAdapter:Lcom/android/settings/profiles/TriggerPagerAdapter;

    invoke-virtual {v0}, Lcom/android/settings/profiles/TriggerPagerAdapter$TriggerFragments;->getFragmentClass()Ljava/lang/Class;

    move-result-object v9

    invoke-virtual {v0}, Lcom/android/settings/profiles/TriggerPagerAdapter$TriggerFragments;->getTitleRes()I

    move-result v10

    invoke-virtual {v7, v9, v3, v10}, Lcom/android/settings/profiles/TriggerPagerAdapter;->add(Ljava/lang/Class;Landroid/os/Bundle;I)V

    goto :goto_1

    .line 134
    .end local v0    # "fragment":Lcom/android/settings/profiles/TriggerPagerAdapter$TriggerFragments;
    :cond_1
    iget-object v6, p0, Lcom/android/settings/profiles/SetupTriggersFragment;->mPager:Landroid/support/v4/view/ViewPager;
    ...
    .line 139
    iget-boolean v6, p0, Lcom/android/settings/profiles/SetupTriggersFragment;->mNewProfileMode:Z
    ...
    new-instance v6, Lcom/android/settings/profiles/SetupTriggersFragment$1;

    invoke-direct {v6, p0}, Lcom/android/settings/profiles/SetupTriggersFragment$1;-><init>(Lcom/android/settings/profiles/SetupTriggersFragment;)V
    ...
    new-instance v7, Lcom/android/settings/profiles/SetupTriggersFragment$2;

    invoke-direct {v7, p0}, Lcom/android/settings/profiles/SetupTriggersFragment$2;-><init>(Lcom/android/settings/profiles/SetupTriggersFragment;)V
