...
# direct methods
.method private constructor <init>(Lcom/android/settingslib/net/UidDetailProvider;Lcom/android/settingslib/AppItem;Landroid/view/View;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary$UidDetailTask;->mProvider:Lcom/android/settingslib/net/UidDetailProvider;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary$UidDetailTask;->mItem:Lcom/android/settingslib/AppItem;
...
.method public static bindView(Lcom/android/settingslib/net/UidDetailProvider;Lcom/android/settingslib/AppItem;Landroid/view/View;)V
    .locals 5
    ...
    .line 2653
    invoke-static {v0, p2}, Lcom/android/settings/DataUsageSummary$UidDetailTask;->bindView(Lcom/android/settingslib/net/UidDetail;Landroid/view/View;)V
    ...
    invoke-direct {v2, p0, p1, p2}, Lcom/android/settings/DataUsageSummary$UidDetailTask;-><init>(Lcom/android/settingslib/net/UidDetailProvider;Lcom/android/settingslib/AppItem;Landroid/view/View;)V
...
.method protected varargs doInBackground([Ljava/lang/Void;)Lcom/android/settingslib/net/UidDetail;
    ...
    .prologue
    .line 2681
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary$UidDetailTask;->mProvider:Lcom/android/settingslib/net/UidDetailProvider;

    iget-object v1, p0, Lcom/android/settings/DataUsageSummary$UidDetailTask;->mItem:Lcom/android/settingslib/AppItem;
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/DataUsageSummary$UidDetailTask;->doInBackground([Ljava/lang/Void;)Lcom/android/settingslib/net/UidDetail;
...
.method protected onPostExecute(Lcom/android/settingslib/net/UidDetail;)V
    ...
    invoke-static {p1, v0}, Lcom/android/settings/DataUsageSummary$UidDetailTask;->bindView(Lcom/android/settingslib/net/UidDetail;Landroid/view/View;)V
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/DataUsageSummary$UidDetailTask;->onPostExecute(Lcom/android/settingslib/net/UidDetail;)V
...
.method protected onPreExecute()V
    ...
    invoke-static {v1, v0}, Lcom/android/settings/DataUsageSummary$UidDetailTask;->bindView(Lcom/android/settingslib/net/UidDetail;Landroid/view/View;)V
