...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/MasterClearConfirm$FrpDialog;
    }
.end annotation
...
.method static synthetic -wrap0(Landroid/content/Context;ZZ)V
    ...
    .prologue
    invoke-static {p0, p1, p2}, Lcom/android/settings/MasterClearConfirm;->doMasterClear(Landroid/content/Context;ZZ)V
...
.method public static createInstance(ZZ)Lcom/android/settings/MasterClearConfirm;
    .locals 3
...
.method private onResetConfirmed()V
    ...
    iget-boolean v3, p0, Lcom/android/settings/MasterClearConfirm;->mEraseExternal:Z

    invoke-static {v1, v2, v3}, Lcom/android/settings/MasterClearConfirm;->doMasterClear(Landroid/content/Context;ZZ)V
    ...
    .line 162
    :cond_2
    iget-boolean v1, p0, Lcom/android/settings/MasterClearConfirm;->mEraseInternal:Z

    iget-boolean v2, p0, Lcom/android/settings/MasterClearConfirm;->mEraseExternal:Z

    invoke-static {v1, v2}, Lcom/android/settings/MasterClearConfirm$FrpDialog;->createInstance(ZZ)Lcom/android/settings/MasterClearConfirm$FrpDialog;

    move-result-object v1

    .line 163
    invoke-virtual {p0}, Lcom/android/settings/MasterClearConfirm;->getFragmentManager()Landroid/app/FragmentManager;
    ...
    .line 162
    invoke-virtual {v1, v2, v3}, Lcom/android/settings/MasterClearConfirm$FrpDialog;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method private setAccessibilityTitle()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/MasterClearConfirm;->getText(I)Ljava/lang/CharSequence;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :cond_1
    iput-boolean v2, p0, Lcom/android/settings/MasterClearConfirm;->mEraseExternal:Z

    .line 234
    const/4 v1, 0x1

    invoke-virtual {p0, v1}, Lcom/android/settings/MasterClearConfirm;->setShowsDialog(Z)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .line 193
    new-instance v2, Lcom/android/settings/MasterClearConfirm$1;

    invoke-direct {v2, p0}, Lcom/android/settings/MasterClearConfirm$1;-><init>(Lcom/android/settings/MasterClearConfirm;)V
    ...
    new-instance v1, Lcom/android/settings/MasterClearConfirm$2;

    invoke-direct {v1, p0}, Lcom/android/settings/MasterClearConfirm$2;-><init>(Lcom/android/settings/MasterClearConfirm;)V
