...
# direct methods
.method static synthetic -get0(Lcom/android/settings/sim/SimSettings$SimEnablerPreference;)Lcom/android/internal/telephony/IExtTelephony;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mExtTelephony:Lcom/android/internal/telephony/IExtTelephony;

    return-object v0
.end method

.method static synthetic -get1(Lcom/android/settings/sim/SimSettings$SimEnablerPreference;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic -get2(Lcom/android/settings/sim/SimSettings$SimEnablerPreference;)Z
    .locals 1
...
.method static synthetic -get3(Lcom/android/settings/sim/SimSettings$SimEnablerPreference;)Landroid/telephony/SubscriptionInfo;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSir:Landroid/telephony/SubscriptionInfo;
...
.method public constructor <init>(Lcom/android/settings/sim/SimSettings;Landroid/content/Context;Landroid/telephony/SubscriptionInfo;I)V
    ...
    .line 464
    invoke-direct {p0, p1, p2, v0, v1}, Lcom/android/settings/sim/SimSettings$SimPreference;-><init>(Lcom/android/settings/sim/SimSettings;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 428
    const-string/jumbo v0, "SimEnablerPreference"

    iput-object v0, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->TAG:Ljava/lang/String;

    .line 453
    iput-boolean v2, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mCmdInProgress:Z

    .line 454
    iput v2, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSwitchVisibility:I
    ...
    .line 467
    iput-object p2, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mContext:Landroid/content/Context;

    .line 468
    iput p4, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSlotId:I

    .line 469
    iput-object p3, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSir:Landroid/telephony/SubscriptionInfo;

    .line 470
    iput-object p3, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSubInfoRecord:Landroid/telephony/SubscriptionInfo;
    ...
    iput-object v0, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mExtTelephony:Lcom/android/internal/telephony/IExtTelephony;

    .line 479
    invoke-virtual {p0, v2}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->setSwitchVisibility(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->setKey(Ljava/lang/String;)V

    .line 481
    invoke-virtual {p0}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->update()V
...
.method private getProvisionStatus(I)I
    ...
    invoke-static {v0}, Lcom/android/settings/sim/SimSettings;->-get3(Lcom/android/settings/sim/SimSettings;)[I
...
.method private getProvisionedSlotId(Landroid/content/Context;)I
    ...
    invoke-static {v4}, Lcom/android/settings/sim/SimSettings;->-get2(Lcom/android/settings/sim/SimSettings;)Landroid/telephony/SubscriptionManager;
    ...
    iget-object v5, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSir:Landroid/telephony/SubscriptionInfo;
...
.method private declared-synchronized handleUserRequest()V
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->showAlertDialog(II)V
    :try_end_0
    ...
    invoke-static {v2}, Lcom/android/settings/sim/SimSettings;->-get1(Lcom/android/settings/sim/SimSettings;)I
...
.method private isCurrentSubValid()Z
    ...
    iget v4, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSlotId:I
    ...
    .line 573
    iput-object v1, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSir:Landroid/telephony/SubscriptionInfo;

    .line 577
    .end local v1    # "sir":Landroid/telephony/SubscriptionInfo;
    :cond_1
    iget-object v4, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSir:Landroid/telephony/SubscriptionInfo;
...
.method private logd(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->TAG:Ljava/lang/String;
...
.method private setChecked(Z)V
    ...
    iget-object v1, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSir:Landroid/telephony/SubscriptionInfo;
...
.method private showAlertDialog(II)V
    ...
    :goto_0
    invoke-static {}, Lcom/android/settings/sim/SimSettings;->-get5()Landroid/app/AlertDialog;
    ...
    .line 750
    invoke-static {}, Lcom/android/settings/sim/SimSettings;->-get6()Landroid/app/ProgressDialog;
    ...
    invoke-static {v4}, Lcom/android/settings/sim/SimSettings;->-set1(Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    ...
    .line 763
    iget-object v6, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mContext:Landroid/content/Context;

    invoke-direct {p0, v6}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->getProvisionedSlotId(Landroid/content/Context;)I
...
.method private showProgressDialog()V
    ...
    .line 814
    iget-object v2, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSir:Landroid/telephony/SubscriptionInfo;
    ...
    invoke-static {v2}, Lcom/android/settings/sim/SimSettings;->-set2(Landroid/app/ProgressDialog;)Landroid/app/ProgressDialog;
...
.method private updateSummary()V
    ...
    invoke-direct {p0, v4}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->logd(Ljava/lang/String;)V
    ...
    :cond_0
    :goto_2
    invoke-virtual {p0, v3}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->setSummary(Ljava/lang/CharSequence;)V
...
.method protected onBindView(Landroid/view/View;)V
    ...
    .line 509
    invoke-super {p0, p1}, Lcom/android/settings/sim/SimSettings$SimPreference;->onBindView(Landroid/view/View;)V
    ...
    iget v2, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSwitchVisibility:I
    ...
    .line 525
    iget-object v2, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSwitch:Landroid/widget/CompoundButton;
    ...
    invoke-direct {p0}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->isCurrentSubValid()Z
...
.method public setSwitchVisibility(I)V
    ...
    .prologue
    .line 589
    iput p1, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSwitchVisibility:I
...
.method public update()V
    ...
    invoke-static {v4}, Lcom/android/settings/sim/SimSettings;->-get3(Lcom/android/settings/sim/SimSettings;)[I
    ...
    .line 536
    iget-object v6, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mExtTelephony:Lcom/android/internal/telephony/IExtTelephony;

    iget v7, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSlotId:I
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->setEnabled(Z)V
    ...
    .line 553
    iget-object v5, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->this$0:Lcom/android/settings/sim/SimSettings;

    invoke-static {v5}, Lcom/android/settings/sim/SimSettings;->-get3(Lcom/android/settings/sim/SimSettings;)[I

    move-result-object v5

    iget v6, p0, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->mSlotId:I
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 555
    if-eqz v2, :cond_1

    .line 556
    invoke-direct {p0}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->updateSummary()V
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0, v4}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->loge(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/sim/SimSettings$SimEnablerPreference;->setSummary(Ljava/lang/CharSequence;)V
