...
.field private mNetworksListView:Lcom/android/settings/DraggableSortListView;
...
# direct methods
.method static synthetic -get0(Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;)Lcom/android/settings/DraggableSortListView$DropListener;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mDropListener:Lcom/android/settings/DraggableSortListView$DropListener;

    return-object v0
.end method

.method static synthetic -get1(Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;)Lcom/android/settings/DraggableSortListView;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mNetworksListView:Lcom/android/settings/DraggableSortListView;

    return-object v0
.end method

.method static synthetic -get2(Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;)Landroid/net/wifi/WifiManager;
    .locals 1
...
.method static synthetic -set0(Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mPrioritiesOrderChanged:Z

    return p1
.end method

.method static synthetic -wrap0(Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;)Z
    .locals 1

    invoke-direct {p0}, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->isAutoConfigPriorities()Z
...
.method public constructor <init>()V
    ...
    .line 67
    iput-object v0, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mDropListener:Lcom/android/settings/DraggableSortListView$DropListener;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings$2;-><init>(Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mSettingsObserver:Landroid/database/ContentObserver;
...
.method private initPreferences()V
    ...
    invoke-static {v2, v4, v5, v4}, Lcom/android/settingslib/wifi/WifiTracker;->getCurrentAccessPoints(Landroid/content/Context;ZZZ)Ljava/util/List;

    move-result-object v6

    .line 255
    .local v6, "accessPoints":Ljava/util/List;, "Ljava/util/List<Lcom/android/settingslib/wifi/AccessPoint;>;"
    new-instance v3, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings$4;

    invoke-direct {v3, p0}, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings$4;-><init>(Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;)V
    ...
    .line 277
    iget-object v3, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mUserBadgeCache:Lcom/android/settings/wifi/AccessPointPreference$UserBadgeCache;

    move v5, v4

    .line 276
    invoke-direct/range {v0 .. v5}, Lcom/android/settings/wifi/AccessPointPreference;-><init>(Lcom/android/settingslib/wifi/AccessPoint;Landroid/content/Context;Lcom/android/settings/wifi/AccessPointPreference$UserBadgeCache;ZZ)V

    .line 278
    .local v0, "preference":Lcom/android/settings/wifi/AccessPointPreference;
    ...
    .line 280
    iput-object v1, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mSelectedAccessPoint:Lcom/android/settingslib/wifi/AccessPoint;

    .line 282
    :cond_0
    invoke-virtual {v0, v8}, Lcom/android/settings/wifi/AccessPointPreference;->setOrder(I)V
    ...
    .line 286
    .end local v0    # "preference":Lcom/android/settings/wifi/AccessPointPreference;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-boolean v0, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mPrioritiesOrderChanged:Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->setHasOptionsMenu(Z)V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    .prologue
    .line 204
    invoke-virtual {p0}, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->isUiRestricted()Z
    ...
    .line 206
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->addOptionsMenuItems(Landroid/view/Menu;)V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .prologue
    .line 165
    new-instance v0, Lcom/android/settings/DraggableSortListView;

    invoke-virtual {p0}, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->getActivity()Landroid/app/Activity;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/android/settings/DraggableSortListView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mNetworksListView:Lcom/android/settings/DraggableSortListView;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/DraggableSortListView;->setId(I)V

    .line 167
    iget-object v0, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mNetworksListView:Lcom/android/settings/DraggableSortListView;

    iget-object v1, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mDropListener:Lcom/android/settings/DraggableSortListView$DropListener;

    invoke-virtual {v0, v1}, Lcom/android/settings/DraggableSortListView;->setDropListener(Lcom/android/settings/DraggableSortListView$DropListener;)V
...
.method public onDetach()V
    ...
    .line 195
    iget-boolean v0, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mPrioritiesOrderChanged:Z
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 229
    iget-object v9, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mNetworksListView:Lcom/android/settings/DraggableSortListView;
    ...
    :goto_2
    invoke-virtual {v9, v6}, Lcom/android/settings/DraggableSortListView;->setDropListener(Lcom/android/settings/DraggableSortListView$DropListener;)V
    ...
    .line 237
    check-cast v6, Lcom/android/settings/wifi/AccessPointPreference;

    invoke-virtual {v6}, Lcom/android/settings/wifi/AccessPointPreference;->getAccessPoint()Lcom/android/settingslib/wifi/AccessPoint;
    ...
    iget-object v6, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 229
    :cond_3
    iget-object v6, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mDropListener:Lcom/android/settings/DraggableSortListView$DropListener;
...
.method public onPause()V
    ...
    .line 159
    invoke-virtual {p0}, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    iget-object v1, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mSettingsObserver:Landroid/database/ContentObserver;
...
.method public onResume()V
    ...
    .line 149
    iget-object v2, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mNetworksListView:Lcom/android/settings/DraggableSortListView;
    ...
    :goto_0
    invoke-virtual {v2, v1}, Lcom/android/settings/DraggableSortListView;->setDropListener(Lcom/android/settings/DraggableSortListView$DropListener;)V
    ...
    .line 153
    iget-object v2, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mSettingsObserver:Landroid/database/ContentObserver;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/android/settings/wifi/SavedAccessPointsWifiSettings;->mPrioritiesOrderChanged:Z
