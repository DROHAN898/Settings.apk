...
.method private setOffMessage()V
    ...
    .prologue
    .line 731
    iget-object v4, p0, Lcom/android/settings/wifi/WifiSettings;->mEmptyView:Landroid/widget/TextView;
...
.method private showDialog(Lcom/android/settingslib/wifi/AccessPoint;Z)V
    .locals 13
...
.method public onAccessPointsChanged()V
    ...
    invoke-virtual {v3}, Lcom/android/settingslib/wifi/WifiTracker;->doSavedNetworksExist()Z
    ...
    :goto_1
    sput-boolean v4, Lcom/android/settings/wifi/WifiSettings;->savedNetworksExist:Z
    ...
    .line 662
    .local v7, "accessPoints":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/android/settingslib/wifi/AccessPoint;>;"
    invoke-virtual {p0}, Lcom/android/settings/wifi/WifiSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    iget-boolean v2, v1, Lcom/android/settingslib/wifi/AccessPoint;->foundInScanResult:Z
    ...
    iget-object v3, p0, Lcom/android/settings/wifi/WifiSettings;->mUserBadgeCache:Lcom/android/settings/wifi/AccessPointPreference$UserBadgeCache;
    ...
    invoke-virtual {v0, v9}, Lcom/android/settings/wifi/AccessPointPreference;->setOrder(I)V
    ...
    .line 691
    invoke-virtual {v1, p0}, Lcom/android/settingslib/wifi/AccessPoint;->setListener(Lcom/android/settingslib/wifi/AccessPoint$AccessPointListener;)V
    ...
    invoke-virtual {p0, v2, v0}, Lcom/android/settings/wifi/WifiSettings;->onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 695
    invoke-virtual {p0, v13}, Lcom/android/settings/wifi/WifiSettings;->setProgressBarVisible(Z)V
    ...
    .end local v7    # "accessPoints":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/android/settingslib/wifi/AccessPoint;>;"
...
.method onAddNetworkPressed()V
    ...
    invoke-direct {p0, v2, v0}, Lcom/android/settings/wifi/WifiSettings;->showDialog(Lcom/android/settingslib/wifi/AccessPoint;Z)V
...
.method public onContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/settings/wifi/WifiSettings;->showDialog(Lcom/android/settingslib/wifi/AccessPoint;Z)V
...
.method public onCreateContextMenu(Landroid/view/ContextMenu;Landroid/view/View;Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    invoke-virtual {v2}, Lcom/android/settings/wifi/AccessPointPreference;->getAccessPoint()Lcom/android/settingslib/wifi/AccessPoint;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    invoke-direct {p0, v0, v2}, Lcom/android/settings/wifi/WifiSettings;->showDialog(Lcom/android/settingslib/wifi/AccessPoint;Z)V
