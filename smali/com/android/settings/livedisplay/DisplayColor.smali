...
# direct methods
.method static synthetic -get0(Lcom/android/settings/livedisplay/DisplayColor;)[F
    .locals 1
...
.method static synthetic -get1(Lcom/android/settings/livedisplay/DisplayColor;)[Lcom/android/settings/livedisplay/DisplayColor$ColorSeekBar;
    .locals 1
...
.method static synthetic -wrap0(Lcom/android/settings/livedisplay/DisplayColor;[F)V
    .locals 0
    .param p1, "colors"    # [F
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Lcom/android/settings/livedisplay/DisplayColor;->mLiveDisplay:Lcyanogenmod/hardware/LiveDisplayManager;
...
.method private updateColors([F)V
    ...
    .prologue
    .line 201
    iget-object v0, p0, Lcom/android/settings/livedisplay/DisplayColor;->mLiveDisplay:Lcyanogenmod/hardware/LiveDisplayManager;
...
.method protected onBindDialogView(Landroid/view/View;)V
    ...
    .line 87
    iget-object v4, p0, Lcom/android/settings/livedisplay/DisplayColor;->mLiveDisplay:Lcyanogenmod/hardware/LiveDisplayManager;

    invoke-virtual {v4}, Lcyanogenmod/hardware/LiveDisplayManager;->getColorAdjustment()[F

    move-result-object v4

    iget-object v5, p0, Lcom/android/settings/livedisplay/DisplayColor;->mOriginalColors:[F

    invoke-static {v4, v7, v5, v7, v6}, Ljava/lang/System;->arraycopy([FI[FII)V

    .line 88
    iget-object v4, p0, Lcom/android/settings/livedisplay/DisplayColor;->mOriginalColors:[F

    iget-object v5, p0, Lcom/android/settings/livedisplay/DisplayColor;->mCurrentColors:[F
    ...
    .local v0, "i":I
    :goto_0
    sget-object v4, Lcom/android/settings/livedisplay/DisplayColor;->SEEKBAR_ID:[I
    ...
    sget-object v4, Lcom/android/settings/livedisplay/DisplayColor;->SEEKBAR_VALUE_ID:[I
    ...
    invoke-direct {v5, p0, v2, v3, v0}, Lcom/android/settings/livedisplay/DisplayColor$ColorSeekBar;-><init>(Lcom/android/settings/livedisplay/DisplayColor;Lcom/android/settings/IntervalSeekBar;Landroid/widget/TextView;I)V
    ...
    invoke-static {v4}, Lcom/android/settings/livedisplay/DisplayColor$ColorSeekBar;->-get0(Lcom/android/settings/livedisplay/DisplayColor$ColorSeekBar;)Lcom/android/settings/IntervalSeekBar;

    move-result-object v4

    const v5, 0x3dcccccd    # 0.1f

    invoke-virtual {v4, v5}, Lcom/android/settings/IntervalSeekBar;->setMinimum(F)V
    ...
    invoke-virtual {v4, v5}, Lcom/android/settings/IntervalSeekBar;->setMaximum(F)V
    ...
    invoke-virtual {v4, v5}, Lcom/android/settings/IntervalSeekBar;->setProgressFloat(F)V
...
.method protected onPrepareDialogBuilder(Landroid/app/AlertDialog$Builder;)V
    ...
    .prologue
    .line 76
    new-instance v0, Lcom/android/settings/livedisplay/DisplayColor$1;

    invoke-direct {v0, p0}, Lcom/android/settings/livedisplay/DisplayColor$1;-><init>(Lcom/android/settings/livedisplay/DisplayColor;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-static {v2}, Lcom/android/settings/livedisplay/DisplayColor$ColorSeekBar;->-get0(Lcom/android/settings/livedisplay/DisplayColor$ColorSeekBar;)Lcom/android/settings/IntervalSeekBar;
    ...
    .line 151
    .end local v0    # "i":I
    .end local v1    # "myState":Lcom/android/settings/livedisplay/DisplayColor$SavedState;
    :cond_0
    ...
    .restart local v1    # "myState":Lcom/android/settings/livedisplay/DisplayColor$SavedState;
    :cond_1
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 133
    .end local v0    # "myState":Lcom/android/settings/livedisplay/DisplayColor$SavedState;
    :cond_0
    return-object v1
.end method
