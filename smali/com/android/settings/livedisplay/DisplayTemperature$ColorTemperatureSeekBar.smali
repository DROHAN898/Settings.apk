...
.method public constructor <init>(Lcom/android/settings/livedisplay/DisplayTemperature;Landroid/widget/SeekBar;Landroid/widget/TextView;)V
    .locals 8
    .param p1, "this$0"    # Lcom/android/settings/livedisplay/DisplayTemperature;
    ...
    .line 231
    invoke-static {p1}, Lcom/android/settings/livedisplay/DisplayTemperature;->-get0(Lcom/android/settings/livedisplay/DisplayTemperature;)Lcyanogenmod/hardware/LiveDisplayConfig;
    ...
    iput v0, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mMin:I
    ...
    iput v0, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mBalanceMin:I
    ...
    iput v0, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mBalanceMax:I
    ...
    .line 236
    iget v0, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mBalanceMin:I

    if-nez v0, :cond_0

    iget v0, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mBalanceMax:I
    ...
    .line 235
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mUseBalance:Z
    ...
    iget v4, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mMax:I
    ...
    iput-object v0, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mBalanceCurve:[D

    .line 240
    iget v0, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mBalanceMax:I

    iget v1, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mBalanceMin:I
    ...
    iget v1, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mBarMax:I
    ...
    invoke-virtual {p0, v0, v6, v7}, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->onProgressChanged(Landroid/widget/SeekBar;IZ)V
    ...
    .line 243
    iget v0, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mMax:I

    iget v1, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mMin:I
...
.method public onProgressChanged(Landroid/widget/SeekBar;IZ)V
    ...
    invoke-static {v1, v8}, Lcom/android/settings/livedisplay/DisplayTemperature;->-wrap0(Lcom/android/settings/livedisplay/DisplayTemperature;Z)V

    .line 260
    :cond_0
    iget-boolean v1, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mUseBalance:Z
    ...
    .line 262
    iget-object v2, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mBalanceCurve:[D
    ...
    invoke-virtual {v1, v2}, Lcom/android/settings/livedisplay/DisplayTemperature;->roundUp(I)I
    ...
    .line 268
    iget-object v1, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mValue:Landroid/widget/TextView;

    iget-object v2, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->this$0:Lcom/android/settings/livedisplay/DisplayTemperature;

    invoke-static {v2}, Lcom/android/settings/livedisplay/DisplayTemperature;->-get1(Lcom/android/settings/livedisplay/DisplayTemperature;)Landroid/content/Context;
    ...
    iget v2, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mMin:I
...
.method public setTemperature(I)V
    ...
    .line 274
    iget-object v1, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mBalanceCurve:[D
    ...
    iget v4, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mBarMax:I
    ...
    iget v4, p0, Lcom/android/settings/livedisplay/DisplayTemperature$ColorTemperatureSeekBar;->mMin:I
