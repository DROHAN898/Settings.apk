...
.method static synthetic -wrap4(Lcom/android/settings/DevelopmentSettings;Z)V
    .locals 0
    .param p1, "isUnlocked"    # Z

    .prologue
    invoke-direct {p0, p1}, Lcom/android/settings/DevelopmentSettings;->updateUsbConfigurationValues(Z)V
...
.method public static initializeUpdateRecoveryOption(Landroid/content/Context;)V
    ...
    .line 1874
    invoke-static {}, Lcom/android/settings/DevelopmentSettings;->resetUpdateRecoveryOptions()V
...
.method private updateAllOptions()V
    ...
    .line 716
    invoke-direct {p0}, Lcom/android/settings/DevelopmentSettings;->updateStayAwakeOptions()V
...
.method private updateAnimationScaleOptions()V
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/settings/DevelopmentSettings;->updateAnimationScaleValue(ILcom/android/settings/AnimationScalePreference;)V
...
.method private updateAnimationScaleValue(ILcom/android/settings/AnimationScalePreference;)V
    .locals 3
    .param p1, "which"    # I
    .param p2, "pref"    # Lcom/android/settings/AnimationScalePreference;
    ...
    .line 1702
    :cond_0
    invoke-virtual {p2, v1}, Lcom/android/settings/AnimationScalePreference;->setScale(F)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private updateRootAccessOptions()V
    ...
    .line 868
    iget-object v1, p0, Lcom/android/settings/DevelopmentSettings;->mRootAppops:Landroid/preference/Preference;
...
.method private updateStayAwakeOptions()V
    ...
    .line 935
    :cond_0
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mKeepScreenOn:Landroid/preference/ListPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAdbNotify:Landroid/preference/SwitchPreference;

    .line 359
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAllPrefs:Ljava/util/ArrayList;

    iget-object v4, p0, Lcom/android/settings/DevelopmentSettings;->mAdbNotify:Landroid/preference/SwitchPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAdbOverNetwork:Landroid/preference/SwitchPreference;
    ...
    .line 372
    iput-object v6, p0, Lcom/android/settings/DevelopmentSettings;->mEnableTerminal:Landroid/preference/SwitchPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mKeepScreenOn:Landroid/preference/ListPreference;
    ...
    .line 382
    iput-object v6, p0, Lcom/android/settings/DevelopmentSettings;->mEnableOemUnlock:Landroid/preference/SwitchPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAdvancedReboot:Landroid/preference/SwitchPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mUpdateRecovery:Landroid/preference/SwitchPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mDevelopmentShortcut:Landroid/preference/SwitchPreference;
    ...
    .line 398
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAdvancedReboot:Landroid/preference/SwitchPreference;

    invoke-direct {p0, v3}, Lcom/android/settings/DevelopmentSettings;->disableForUser(Landroid/preference/Preference;)V

    .line 399
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mUpdateRecovery:Landroid/preference/SwitchPreference;

    invoke-direct {p0, v3}, Lcom/android/settings/DevelopmentSettings;->disableForUser(Landroid/preference/Preference;)V

    .line 400
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mDevelopmentShortcut:Landroid/preference/SwitchPreference;
    ...
    .line 457
    iput-object v6, p0, Lcom/android/settings/DevelopmentSettings;->mEnableMultiWindow:Landroid/preference/SwitchPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mKillAppLongpressBack:Landroid/preference/SwitchPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mRootAppops:Landroid/preference/Preference;

    .line 487
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mRootAppops:Landroid/preference/Preference;
    ...
    .line 490
    invoke-direct {p0}, Lcom/android/settings/DevelopmentSettings;->isRootForAppsAvailable()Z
    ...
    iget-object v4, p0, Lcom/android/settings/DevelopmentSettings;->mRootAppops:Landroid/preference/Preference;
    ...
    .line 502
    invoke-static {v3, v4, v5, v7}, Lcom/android/settings/Utils;->updatePreferenceToSpecificActivityOrRemove(Landroid/content/Context;Landroid/preference/PreferenceGroup;Ljava/lang/String;I)Z
    ...
    check-cast v3, Lcom/android/settings/ColorModePreference;

    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mColorModePreference:Lcom/android/settings/ColorModePreference;

    .line 508
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mColorModePreference:Lcom/android/settings/ColorModePreference;

    invoke-virtual {v3}, Lcom/android/settings/ColorModePreference;->updateCurrentAndSupported()V

    .line 509
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mColorModePreference:Lcom/android/settings/ColorModePreference;

    invoke-virtual {v3}, Lcom/android/settings/ColorModePreference;->getTransformsCount()I
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mColorTemperaturePreference:Landroid/preference/SwitchPreference;
    ...
    iget-object v4, p0, Lcom/android/settings/DevelopmentSettings;->mColorTemperaturePreference:Landroid/preference/SwitchPreference;
    ...
    .line 525
    iput-object v6, p0, Lcom/android/settings/DevelopmentSettings;->mUpdateRecovery:Landroid/preference/SwitchPreference;
    ...
    .line 520
    iput-object v6, p0, Lcom/android/settings/DevelopmentSettings;->mColorTemperaturePreference:Landroid/preference/SwitchPreference;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v4, v0, p2}, Lcom/android/settings/DevelopmentSettings;->writeAnimationScaleOption(ILcom/android/settings/AnimationScalePreference;Ljava/lang/Object;)V
    ...
    invoke-direct {p0, v3, v0, p2}, Lcom/android/settings/DevelopmentSettings;->writeAnimationScaleOption(ILcom/android/settings/AnimationScalePreference;Ljava/lang/Object;)V
    ...
    .line 2205
    :cond_10
    iget-object v0, p0, Lcom/android/settings/DevelopmentSettings;->mKeepScreenOn:Landroid/preference/ListPreference;

    if-ne p1, v0, :cond_11

    .line 2206
    invoke-direct {p0, p2}, Lcom/android/settings/DevelopmentSettings;->writeStayAwakeOptions(Ljava/lang/Object;)V
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 1945
    iget-object v2, p0, Lcom/android/settings/DevelopmentSettings;->mRootAppops:Landroid/preference/Preference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 1985
    iget-object v6, p0, Lcom/android/settings/DevelopmentSettings;->mAdbNotify:Landroid/preference/SwitchPreference;
    ...
    .line 1986
    :cond_6
    iget-object v4, p0, Lcom/android/settings/DevelopmentSettings;->mAdbOverNetwork:Landroid/preference/SwitchPreference;

    if-ne p2, v4, :cond_9

    .line 1987
    iget-object v2, p0, Lcom/android/settings/DevelopmentSettings;->mAdbOverNetwork:Landroid/preference/SwitchPreference;
    ...
    .line 2102
    :cond_33
    iget-object v2, p0, Lcom/android/settings/DevelopmentSettings;->mKillAppLongpressBack:Landroid/preference/SwitchPreference;
    ...
    .line 2106
    iget-object v2, p0, Lcom/android/settings/DevelopmentSettings;->mUpdateRecoveryDialog:Landroid/app/Dialog;
    ...
    iput-object v2, p0, Lcom/android/settings/DevelopmentSettings;->mUpdateRecoveryDialog:Landroid/app/Dialog;
...
.method public onResume()V
    ...
    iget-object v5, p0, Lcom/android/settings/DevelopmentSettings;->mKeepScreenOn:Landroid/preference/ListPreference;
