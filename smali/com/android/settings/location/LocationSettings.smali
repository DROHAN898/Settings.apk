...
.method private addLocationServices(Landroid/content/Context;Landroid/preference/PreferenceScreen;Z)V
    ...
    invoke-static {p1}, Lcom/android/settings/location/IzatSettingsInjector;->getSettingInjector(Landroid/content/Context;)Lcom/android/settings/location/SettingsInjector;
...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    .line 212
    iput-object v6, p0, Lcom/android/settings/location/LocationSettings;->mLtoDownloadDataWifiOnly:Landroid/preference/SwitchPreference;

    .line 214
    iget-object v6, p0, Lcom/android/settings/location/LocationSettings;->mLtoDownloadDataWifiOnly:Landroid/preference/SwitchPreference;

    if-eqz v6, :cond_1

    .line 215
    invoke-static {v0}, Lcom/android/settings/location/LocationSettings;->isLtoSupported(Landroid/content/Context;)Z

    move-result v6

    if-eqz v6, :cond_3

    invoke-static {v0}, Lcom/android/settings/location/LocationSettings;->checkGpsDownloadWiFiOnly(Landroid/content/Context;)Z
    ...
    .line 217
    iput-object v8, p0, Lcom/android/settings/location/LocationSettings;->mLtoDownloadDataWifiOnly:Landroid/preference/SwitchPreference;
...
.method public static restore(Landroid/content/Context;)V
    ...
    .prologue
    .line 456
    invoke-static {p0}, Lcom/android/settings/location/LocationSettings;->isLtoSupported(Landroid/content/Context;)Z
...
.method public onModeChanged(IZ)V
    ...
    .line 366
    iget-object v1, p0, Lcom/android/settings/location/LocationSettings;->mLtoDownloadDataWifiOnly:Landroid/preference/SwitchPreference;

    if-eqz v1, :cond_1

    .line 367
    iget-object v4, p0, Lcom/android/settings/location/LocationSettings;->mLtoDownloadDataWifiOnly:Landroid/preference/SwitchPreference;
    ...
    .line 383
    :cond_4
    iget-object v1, p0, Lcom/android/settings/location/LocationSettings;->mManagedProfilePreference:Landroid/preference/Preference;

    if-eqz v1, :cond_5

    .line 384
    iget-object v1, p0, Lcom/android/settings/location/LocationSettings;->mUm:Landroid/os/UserManager;
    ...
    :pswitch_0
    iget-object v1, p0, Lcom/android/settings/location/LocationSettings;->mLocationMode:Landroid/preference/Preference;
    ...
    invoke-direct {p0, v3, v1}, Lcom/android/settings/location/LocationSettings;->changeManagedProfileLocationAccessStatus(ZI)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .prologue
    .line 415
    iget-object v0, p0, Lcom/android/settings/location/LocationSettings;->mLtoDownloadDataWifiOnly:Landroid/preference/SwitchPreference;
