...
# direct methods
.method static synthetic -get0(Lcom/android/settings/DisplaySettings;)Lcom/android/settings/FontDialogPreference;
    .locals 1
...
.method static synthetic -wrap4(Lcom/android/settings/DisplaySettings;)V
    .locals 0
...
.method static synthetic -wrap5(Lcom/android/settings/DisplaySettings;)V
    .locals 0
...
.method static synthetic -wrap6(Lcom/android/settings/DisplaySettings;I)V
    .locals 0
    .param p1, "currentDensity"    # I

    .prologue
    invoke-direct {p0, p1}, Lcom/android/settings/DisplaySettings;->updateLcdDensityPreferenceDescription(I)V

    return-void
.end method

.method static synthetic -wrap7(Lcom/android/settings/DisplaySettings;Landroid/content/Context;I)V
    .locals 0
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "density"    # I

    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/settings/DisplaySettings;->writeLcdDensityPreference(Landroid/content/Context;I)V
...
.method private showLcdConfirmationDialog(Ljava/lang/String;)V
    ...
    .line 772
    new-instance v1, Lcom/android/settings/DisplaySettings$6;

    invoke-direct {v1, p0, p1}, Lcom/android/settings/DisplaySettings$6;-><init>(Lcom/android/settings/DisplaySettings;Ljava/lang/String;)V
...
.method private updateLcdDensityPreferenceDescription(I)V
    ...
    .prologue
    .line 463
    invoke-direct {p0}, Lcom/android/settings/DisplaySettings;->getDefaultDensity()I
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/settings/DisplaySettings;->mLcdDensityPreference:Landroid/preference/ListPreference;
...
.method private writeLcdDensityPreference(Landroid/content/Context;I)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/settings/DisplaySettings$5;-><init>(Lcom/android/settings/DisplaySettings;Landroid/content/Context;Landroid/view/IWindowManager;ILandroid/app/IActivityManager;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, v1, Lcom/android/settings/DisplaySettings;->mHardware:Lcyanogenmod/hardware/CMHardwareManager;
    ...
    iput-object v0, v1, Lcom/android/settings/DisplaySettings;->mAccelerometer:Landroid/preference/SwitchPreference;

    .line 181
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/DisplaySettings;->mAccelerometer:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/DisplaySettings;->mLiveDisplayPreference:Landroid/preference/PreferenceScreen;
    ...
    iget-object v0, v0, Lcom/android/settings/DisplaySettings;->mLiveDisplayPreference:Landroid/preference/PreferenceScreen;
    ...
    iput-object v0, v1, Lcom/android/settings/DisplaySettings;->mLcdDensityPreference:Landroid/preference/ListPreference;

    .line 207
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/DisplaySettings;->mLcdDensityPreference:Landroid/preference/ListPreference;
    ...
    check-cast v24, Lcom/android/settings/FontDialogPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/DisplaySettings;->mAutoBrightnessPreference:Landroid/preference/SwitchPreference;
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/settings/DisplaySettings;->isAutomaticBrightnessAvailable(Landroid/content/res/Resources;)Z
    ...
    invoke-static {v4}, Lcom/android/settings/Utils;->isDozeAvailable(Landroid/content/Context;)Z
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/settings/DisplaySettings;->isCameraGestureAvailable(Landroid/content/res/Resources;)Z
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/settings/DisplaySettings;->isTapToWakeAvailable(Landroid/content/res/Resources;)Z
    ...
    iput-object v0, v1, Lcom/android/settings/DisplaySettings;->mHighTouchSensitivity:Landroid/preference/SwitchPreference;

    .line 306
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/DisplaySettings;->mHardware:Lcyanogenmod/hardware/CMHardwareManager;
    ...
    iget-object v0, v0, Lcom/android/settings/DisplaySettings;->mHighTouchSensitivity:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/DisplaySettings;->mProximityCheckOnWakePreference:Landroid/preference/SwitchPreference;
    ...
    iget-object v0, v0, Lcom/android/settings/DisplaySettings;->mProximityCheckOnWakePreference:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/DisplaySettings;->mWakeWhenPluggedOrUnplugged:Landroid/preference/SwitchPreference;
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/DisplaySettings;->initPulse(Landroid/preference/PreferenceCategory;)V
    ...
    :cond_b
    invoke-direct/range {p0 .. p0}, Lcom/android/settings/DisplaySettings;->getDefaultDensity()I

    move-result v10

    .line 212
    .local v10, "defaultDensity":I
    invoke-direct/range {p0 .. p0}, Lcom/android/settings/DisplaySettings;->getCurrentDensity()I
    ...
    invoke-direct {v0, v5}, Lcom/android/settings/DisplaySettings;->updateLcdDensityPreferenceDescription(I)V
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    invoke-direct {v1, p0}, Lcom/android/settings/DisplaySettings$4;-><init>(Lcom/android/settings/DisplaySettings;)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v10, p0, Lcom/android/settings/DisplaySettings;->mLcdDensityPreference:Landroid/preference/ListPreference;
    ...
    invoke-direct {p0, p2}, Lcom/android/settings/DisplaySettings;->showLcdConfirmationDialog(Ljava/lang/String;)V
    ...
    .line 732
    :cond_3
    iget-object v10, p0, Lcom/android/settings/DisplaySettings;->mAutoBrightnessPreference:Landroid/preference/SwitchPreference;
    ...
    .end local v2    # "auto":Z
    :cond_4
    iget-object v10, p0, Lcom/android/settings/DisplaySettings;->mLiftToWakePreference:Landroid/preference/SwitchPreference;
    ...
    :cond_5
    iget-object v10, p0, Lcom/android/settings/DisplaySettings;->mDozePreference:Landroid/preference/SwitchPreference;
    ...
    .end local v9    # "value":Z
    :cond_6
    iget-object v10, p0, Lcom/android/settings/DisplaySettings;->mTapToWakePreference:Landroid/preference/SwitchPreference;
    ...
    .end local v9    # "value":Z
    :cond_7
    iget-object v10, p0, Lcom/android/settings/DisplaySettings;->mCameraGesturePreference:Landroid/preference/SwitchPreference;
    ...
    .end local v9    # "value":Z
    :cond_8
    iget-object v10, p0, Lcom/android/settings/DisplaySettings;->mNightModePreference:Landroid/preference/ListPreference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 690
    iget-object v3, p0, Lcom/android/settings/DisplaySettings;->mWakeWhenPluggedOrUnplugged:Landroid/preference/SwitchPreference;
    ...
    .line 698
    :cond_4
    iget-object v3, p0, Lcom/android/settings/DisplaySettings;->mHighTouchSensitivity:Landroid/preference/SwitchPreference;
...
.method public readFontSizePreference(Landroid/preference/Preference;)V
    ...
    invoke-virtual {p0, v4, v3}, Lcom/android/settings/DisplaySettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
